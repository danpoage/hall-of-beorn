    ...
    public class CategoryService
    {
        ...
        private void LoadCategories()
        {
            var filters = new List<Func<Card, Category>>
            {
                ...
                CreateCategoryFilter(@"(return.*discard[\s]pile.*hand|shuffle.*discard[\s]pile.*back|discard pile.*into play|discard pile.*shuffle|shuffle.*card.*discard pile.*into.*deck|(from|in) your discard pile)", Category.Recursion, "encounter discard pile", "Shuffle the encounter deck"),
