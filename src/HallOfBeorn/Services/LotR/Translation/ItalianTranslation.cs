        ...
        : TranslationBase
    {
        ...
        protected override Dictionary<string, string> AddTitles()
        {
            ...
            SafeMap(all, new Dictionary<string, string> {
                ...
                { "Beorning Pony", "Pony Beorniano" },
                { "Beorn's Welcome", "Il Benvenuto di Beorn" },
                { "Bitter Betrayal", "Un Tradimento Amaro" },
                { "Coup", "Colpo di Stato" },
                { "Curuwyn The Whisperer", "Curuwyn Colei Che Sussurra" },
                { "Cutthroat's Strike", "Colpo del Tagliagole" },
                { "Deeping-stream", "Torrente Fossato" },
                { "Descendants of Beorn", "Discendenti di Beorn" },
                { "Devoted Determination", "Devozione Determinata" },
                { "Felberen Scion of Freca", "Felberen Discendente di Freca" },
                { "Halls of Ealdwulf", "Le Sale di Ealdwulf" },
                { "Host of Rohan", "Schiera di Rohan" },
                { "Hunting Dogs", "Segugi da Caccia" },
                { "Lie of the Land", "Perlustrare il Territorio" },
                { "Massing at the Isen", "Schieramento all'Isen" },
                { "Oaths of the Rohirrim", "I Giuramenti dei Rohirrim" },
                { "Orator's Hall", "Salone degli Oratori" },
                { "Orc-host Remnant", "Resti dell'Armata degli Orchi" },
                { "Pernicious Plotter", "Cospiratore Infido" },
                { "Plains of Strife", "Pianure Contese" },
                { "Raven Clan Sharpshooter", "Tiratore del Clan del Corvo" },
                { "Raven Clan Warchief", "Capo del Clan del Corvo" },
                { "Road to Ruin", "La Strada verso la Rovina" },
                { "Scattered to the Winds", "Sparsi ai Quattro Venti" },
                { "Seeking Support", "In Cerca di Sostegno" },
                { "Smeóhbrand Rogue of Orthanc", "Smeóhbrand Canaglia di Orthanc" },
                { "Sniveling Courtier", "Cortigiano Lamentoso" },
                { "Spiteful Hunter", "Cacciatore Iracondo" },
                { "Subdued", "Soggiogato" },
                { "The Far Bank", "La Riva Lontana" },
                { "Traitor's Redoubt", "Rifugio dei Traditori" },
