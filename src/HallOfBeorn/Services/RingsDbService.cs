...
namespace HallOfBeorn.Services
{
    public class RingsDbService
    {
        ...
        private void initializePopularity()
        {
            ...
            addPopularity("010030", 3);
            addPopularity("010088", 3);
            addPopularity("010122", 3);
            ...
            addPopularity("010005", 3);
            addPopularity("010124", 3);
            addPopularity("011009", 3);
            ...
            addPopularity("010036", 1);
            addPopularity("010056", 1);
            addPopularity("010063", 1);
            addPopularity("010117", 1);
            addPopularity("010123", 1);
            addPopularity("010148", 1);
            addPopularity("011008", 1);
