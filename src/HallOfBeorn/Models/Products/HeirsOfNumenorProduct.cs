...
namespace HallOfBeorn.Models.Products
{
    public class HeirsOfNumenorProduct : Product
    {
            ...
            : base("Heirs of Númenor", "MEC17", ImageType.Png, new DateTime(2012, 11, 26))
        {
            ...
            AddScenario(new HallOfBeorn.Models.Scenarios.PerilInPelargir());
            AddScenario(new HallOfBeorn.Models.Scenarios.IntoIthilien());
            AddScenario(new HallOfBeorn.Models.Scenarios.TheSiegeOfCairAndros());
        }
    }
}