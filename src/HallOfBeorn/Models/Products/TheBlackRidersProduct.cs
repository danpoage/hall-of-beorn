...
namespace HallOfBeorn.Models.Products
{
    public class TheBlackRidersProduct : Product
    {
            ...
            : base("The Black Riders", "MEC32", ImageType.Png)
        {
            ...
            AddScenario(new HallOfBeorn.Models.Scenarios.AShadowOfThePast());
            AddScenario(new HallOfBeorn.Models.Scenarios.AKnifeInTheDark());
            AddScenario(new HallOfBeorn.Models.Scenarios.FlightToTheFord());
        }
    }
}