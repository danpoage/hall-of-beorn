...
namespace HallOfBeorn.Models.Products
{
    public class TheTreasonOfSarumanProduct : Product
    {
            ...
            : base("The Treason of Saruman", "MEC45", ImageType.Jpg, new DateTime(2015, 4, 23))
        {
            ...
            AddScenario(new HallOfBeorn.Models.Scenarios.TheUrukHai());
            AddScenario(new HallOfBeorn.Models.Scenarios.HelmsDeep());
            AddScenario(new HallOfBeorn.Models.Scenarios.TheRoadToIsengard());
        }
    }
}