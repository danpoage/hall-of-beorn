...
namespace HallOfBeorn.Models.Products
{
    public class TheVoiceOfIsengardProduct : Product
    {
            ...
            : base("The Voice of Isengard", "MEC25", ImageType.Png, new DateTime(2014, 2, 21))
        {
            ...
            AddScenario(new HallOfBeorn.Models.Scenarios.TheFordsOfIsen());
            AddScenario(new HallOfBeorn.Models.Scenarios.ToCatchAnOrc());
            AddScenario(new HallOfBeorn.Models.Scenarios.IntoFangorn());
        }
    }
}