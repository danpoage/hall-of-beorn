...
Finally, flip this setup card over and place it next to the quest deck. Its effect remains active throughout the game, which is now ready to begin.")
            ...
            addCard(LotRCard.Location("Prison Cell", string.Empty, setName, 2, 3)
                ...
                .WithKeywords("Capture 1.")
                .WithText("While Prison Cell is the active location, it gains: \"Planning Action: Rescue a random cards from underneath Prison Cell. Then, raise each player's threat by X, where X is that card's printing code (Limit once per round).\"")
