...
namespace HallOfBeorn.Models.LotR.Sets
{
    public class TheBlackSerpent : CardSet
    {
        protected override void Initialize()
        {
            ...
            Cards.Add(LotRCard.PlayerSideQuest("Rally the West", string.Empty, Sphere.Spirit, 1, 6)
            ...
            Cards.Add(LotRCard.Event("Oath of Eorl", string.Empty, Sphere.Tactics, 3)
            ...
            Cards.Add(LotRCard.Event("Old Toby", string.Empty, Sphere.Lore, 2)
                .WithTraits("Pipeweed.")
