...
namespace HallOfBeorn.Models.LotR.Sets
{
    public class TheTreasonOfSaruman : CardSet
    {
        protected override void Initialize()
        {
            ...
            Cards.Add(LotRCard.Quest("Follow the Orcs", "1AD0CFEB-9A20-4802-A2F9-6D8137967E53", 7, 1, "The Uruk-hai", 254)
            ...
            Cards.Add(LotRCard.Quest("Rescue the Captives", "76744E42-56C0-4B65-B13F-1984F9EAF248", 7, 2, "The Uruk-hai", 254)
            ...
            Cards.Add(LotRCard.Campaign("The Uruk-hai", "188132B7-CFF0-4803-8055-848343033A2D", 7, "The Uruk-hai", "The Lord of the Rings Part 7")
            ...
            Cards.Add(LotRCard.Quest("The King of the Golden Hall", "F80E3197-33B4-4132-8A2D-9203AB1CA181", 8, 1, "Helm's Deep", 255)
            ...
            Cards.Add(LotRCard.Quest("Assault on Helm's Deep", "15F98A94-520E-4774-BBFF-9E331511A8BD", 8, 2, "Helm's Deep", 8)
            ...
            Cards.Add(LotRCard.Quest("The Hosts of Isengard", "58BD7102-7CCB-4EA8-BE69-04C94081E1D9", 8, 3, "Helm's Deep", 8)
                .WithKeywords("Defense.")
            ...
            Cards.Add(LotRCard.Quest("The Wall is Breached!", "00995C4A-E4D7-487A-B1AA-084B9C2BE75C", 8, 4, "Helm's Deep", 8)
                .WithKeywords("Defense.")
            ...
            Cards.Add(LotRCard.Quest("The King Rides Out", "AC1A3051-5820-427D-AD95-B0858D52B264", 8, 5, "Helm's Deep", 255)
            ...
            Cards.Add(LotRCard.Campaign("Helm's Deep", "B0A17346-311F-4A71-A68F-EDBBD10493B9", 8, "Helm's Deep", "The Lord of the Rings Part 8")
            ...
            Cards.Add(LotRCard.Quest("Rouse the Ents", "CA1724AC-2257-448A-A7E9-95DC747C875F", 9, 1, "The Road to Isengard", 255)
            ...
            Cards.Add(LotRCard.Quest("Breaking Isengard", "227838F9-061E-4A76-89DD-B471B67C01E1", 9, 2, "The Road to Isengard", 255)
            ...
            Cards.Add(LotRCard.Quest("The Voice of Saruman", "3D397200-CBF9-4195-A444-B4F4B8DE40EA", 9, 3, "The Road to Isengard", 15)
            ...
            Cards.Add(LotRCard.Campaign("The Road to Isengard", "B0DE0027-1DAE-46E6-B6D4-E5BC123BB445", 9, "The Road to Isengard", "The Lord of the Rings Part 9")
