...
namespace HallOfBeorn.Models.LotR.Sets
{
    public class TheSiegeOfAnnuminas : CardSet
    {
        ...
        protected override void Initialize()
        {
            ...
            Cards.Add(LotRCard.Quest("Rebuild the Defenses", string.Empty, 7, 1, setName, null)
            ...
            Cards.Add(LotRCard.Quest("Defend the City", string.Empty, 7, 2, setName, 50)
            ...
            Cards.Add(LotRCard.Quest("Lead the Sortie", string.Empty, 7, 3, setName, null)
            ...
            Cards.Add(LotRCard.Quest("Raise the Levee", string.Empty, 7, 1, setName, null)
                .WithStageLetter('C')
            ...
            Cards.Add(LotRCard.Quest("Guard the Gate", string.Empty, 7, 2, setName, 50)
                .WithStageLetter('C')
            ...
            Cards.Add(LotRCard.Quest("Rescue the Captives", string.Empty, 7, 3, setName, null)
                .WithStageLetter('C')
            ...
            Cards.Add(LotRCard.Quest("Delay the Enemy", string.Empty, 7, 1, setName, null)
                .WithStageLetter('E')
            ...
            Cards.Add(LotRCard.Quest("Man the Walls", string.Empty, 7, 2, setName, 50)
                .WithStageLetter('E')
            ...
            Cards.Add(LotRCard.Quest("Stop the Attack", string.Empty, 7, 3, setName, null)
                .WithStageLetter('E')
