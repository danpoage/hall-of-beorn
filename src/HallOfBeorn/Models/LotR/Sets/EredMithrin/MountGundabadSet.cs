    ...
    public class MountGundabadSet : CardSet
    {
        protected override void Initialize()
        {
            ...
            addAttachment("Armor of Erebor", 2, Sphere.Spirit, false)
                .WithTraits("Item.", "Armor.")
                .WithKeywords("Restricted.")
                .WithTextLine("Attach to a Dale or Dwarf character.")
            ...
            addEnemy("Dagnir", EncounterSet.MountGundabad, 50, Card.VALUE_X, 7, 5, 20)
                ...
                .WithTextLine("Immune to player card effects. X is 1 more than the number of quest cards in the victory display.")
