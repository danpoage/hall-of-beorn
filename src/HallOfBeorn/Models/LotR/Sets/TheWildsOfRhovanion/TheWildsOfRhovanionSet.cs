    ...
    public class TheWildsOfRhovanionSet : CardSet
    {
        protected override void Initialize()
        {
            ...
            addQuest("Ambushed at Night", EncounterSet.LostInMirkwood.Name, 1, 'A', 255)
                .WithIncludedEncounterSets(EncounterSet.LostInMirkwood, EncounterSet.DarkWoods, EncounterSet.GatheringGloom, EncounterSet.PassageThroughMirkwood, EncounterSet.SpidersOfMirkwood, EncounterSet.DolGuldurOrcs)
