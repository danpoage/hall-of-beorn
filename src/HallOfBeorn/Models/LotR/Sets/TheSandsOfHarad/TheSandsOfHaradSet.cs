...
namespace HallOfBeorn.Models.LotR.Sets.TheSandsOfHarad
{
    public class TheSandsOfHaradSet : CardSet
    {
        ...
        protected override void Initialize()
        {
            ...
            addCard(LotRCard.Ally("Vigilant Dúnadan", Sphere.Tactics, 4, 1, 3, 2, 3)
            ...
            addCard(LotRCard.Quest("Stranded in Umbar", 1, setEscape, 15)
            ...
            addCard(LotRCard.Quest("Flee the City", 2, setEscape, 15)
            ...
            addCard(LotRCard.Quest("The Desert of Harad", 1, setCrossing, 8)
            ...
            addCard(LotRCard.Quest("Under the Merciless Sun", 2, setCrossing, 14)
            ...
            addCard(LotRCard.Quest("Beasts of Legend", 3, setCrossing, 16)
            ...
            addCard(LotRCard.Quest("Surprise Attack", 1, setLongArm, 0)
            ...
            addCard(LotRCard.Quest("Find the Others", 2, setLongArm, 5)
            ...
            addCard(LotRCard.Quest("Free the Captives", 3, setLongArm, 10)
            ...
            addCard(LotRCard.Quest("Escape into the Jungle", 4, setLongArm, 15)
