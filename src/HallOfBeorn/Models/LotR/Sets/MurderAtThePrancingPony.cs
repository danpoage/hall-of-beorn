    ...
    public class MurderAtThePrancingPony : CardSet
    {
        ...
        protected override void Initialize()
        {
            ...
            Cards.Add(LotRCard.GenConSetup("Murder at the Prancing Pony Scenario Rules 4-5", setName)
                ...
                .WithInfo(0, 1, Artist.None));
            Cards.Add(LotRCard.Quest("Investigating the Crime", "", 6, 1, setName, 12)
            ...
            Cards.Add(LotRCard.Quest("Running out of Time", "", 6, 2, setName, 255)
            ...
            Cards.Add(LotRCard.Quest("Apprehending the Killer", "", 6, 3, setName, 255)
