...
Page 4/4",
            ...
            Cards.Add(LotRCard.Quest("Ruins of the First Age", "", 6, 1, "The Ruins of Belegost", 6)
            ...
            Cards.Add(LotRCard.Quest("Ancient Evils Disturbed", "", 6, 2, "The Ruins of Belegost", 9)
            ...
            Cards.Add(LotRCard.Quest("Deeper into the Past", "", 6, 2, "The Ruins of Belegost", 9, 'C')
            ...
            Cards.Add(LotRCard.Quest("The Servants of Morgoth", "", 6, 3, "The Ruins of Belegost", 6)
            ...
            Cards.Add(LotRCard.Quest("The Roots of Ered Luin", "", 6, 3, "The Ruins of Belegost", 6, 'C')
                .WithText("When Revealed: Shuffle the encounter discard pile into the encounter deck and reveal 1 encounter card per player.")
            ...
            Cards.Add(LotRCard.Quest("The Mines of Belegost", "", 6, 3, "The Ruins of Belegost", 6, 'E')
                .WithText("When Revealed: Shuffle the encounter discard pile into the encounter deck and reveal 1 encounter card per player.")
            ...
            Cards.Add(LotRCard.Quest("The Beast of Belegost", "", 6, 4, "The Ruins of Belegost", 255)
