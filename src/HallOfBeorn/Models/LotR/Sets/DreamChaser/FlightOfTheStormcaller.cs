...
namespace HallOfBeorn.Models.LotR.Sets.DreamChaser
{
    public class FlightOfTheStormcaller : CardSet
    {
        ...
        protected override void Initialize()
        {
            ...
            Cards.Add(LotRCard.Quest("Swift Departure", 1, setName, 8)
            ...
            Cards.Add(LotRCard.Quest("Full Sail Ahead", 2, setName, 12)
                .WithSuffix("AB")
            ...
            Cards.Add(LotRCard.Quest("The Weather Turns Foul", 3, setName, 18)
                .WithSuffix("AB")
            ...
            Cards.Add(LotRCard.Quest("The Cape of Andrast", 4, setName, 24)
                .WithSuffix("AB")
            ...
            Cards.Add(LotRCard.Quest("Full Sail Ahead", 2, setName, 12, 'C')
                .WithSuffix("CD")
            ...
            Cards.Add(LotRCard.Quest("The Weather Turns Foul", 3, setName, 18, 'C')
                .WithSuffix("CD")
            ...
            Cards.Add(LotRCard.Quest("The Cape of Andrast", 4, setName, 24, 'C')
                .WithSuffix("CD")
