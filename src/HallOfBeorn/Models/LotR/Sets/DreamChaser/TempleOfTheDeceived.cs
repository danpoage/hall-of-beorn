...
namespace HallOfBeorn.Models.LotR.Sets.DreamChaser
{
    public class TempleOfTheDeceived : CardSet
    {
        ...
        protected override void Initialize()
        {
            ...
            Cards.Add(LotRCard.Hero("Elfhelm", "", Sphere.Leadership, 10, 2, 2, 2, 4)
            ...
            Cards.Add(LotRCard.Ally("Ceorl", Sphere.Leadership, 2, 1, 2, 0, 2)
                .WithUnique()
            ...
            Cards.Add(LotRCard.Attachment("Armored Destrier", "", Sphere.Leadership, 2)
                .WithTraits("Mount.")
            ...
            Cards.Add(LotRCard.Ally("Déorwine", Sphere.Tactics, 4, 0, 1, 3, 3)
                .WithUnique()
            ...
            Cards.Add(LotRCard.Event("Scouting Party", "", Sphere.Spirit, 2)
            ...
            Cards.Add(LotRCard.Attachment("Entangling Nets", "", Sphere.Lore, 1)
                .WithTraits("Trap.")
            ...
            Cards.Add(LotRCard.Event("Arrows from the Trees", "", Sphere.Lore, 1)
            ...
            Cards.Add(LotRCard.Ally("Ered Luin Miner", Sphere.Neutral, 3, 1, 1, 1, 2)
                .WithTraits("Dwarf.")
            ...
            Cards.Add(LotRCard.Objective("Gate Key", "", setName)
                .WithUnique()
            ...
            Cards.Add(LotRCard.Enemy("Faithless Desecrator", "", setName, 25, 2, 2, 2, 4)
                .WithTraits("Undead.")
            ...
            Cards.Add(LotRCard.Enemy("Island Watcher", "", setName, 46, 3, 4, 1, 5)
                .WithTraits("Undead.")
            ...
            Cards.Add(LotRCard.Enemy("Profane Dead", "", setName, 35, 1, 2, 3, 3)
                .WithTraits("Undead.")
            ...
            Cards.Add(LotRCard.Treachery("Deeper into the Ruins", "", setName)
            ...
            Cards.Add(LotRCard.Treachery("Furious Rainstorm", "", setName)
            ...
            Cards.Add(LotRCard.Treachery("Dwindling Supplies", "", setName)
            ...
            Cards.Add(LotRCard.Treachery("Sunken Ruins", "", setName)
