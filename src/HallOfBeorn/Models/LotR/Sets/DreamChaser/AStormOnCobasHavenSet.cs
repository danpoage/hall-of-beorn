...
namespace HallOfBeorn.Models.LotR.Sets.DreamChaser
{
    public class AStormOnCobasHavenSet : CardSet
    {
        ...
        protected override void Initialize()
        {
            ...
            addQuest("Outmaneuver the Enemy", setName, 1, 'A', 10)
            ...
            addQuest("Battle in the Bay", setName, 2, 'A', 16)
            ...
            addQuest("Break Through the Fleet!", setName, 3, 'A', 5)
            ...
            addShipObjective("Dol Amroth Warship", setName, false, 2, 2, 2, 8)
            ...
            addShipEnemy("Raider Flagship", setName, 50, 3, 5, 3, 18)
                .WithUnique()
            ...
            addShipEnemy("Siege Ship", setName, 46, 2, 5, 5, 7)
                .WithTraits("Corsair.", "Ship.")
            ...
            addShipEnemy("Heavy Cruiser", setName, 42, 5, 7, 5, 8)
                .WithTraits("Corsair.", "Ship.")
            ...
            addLocation("Coast of Anfalas", setName, 3, 3)
            ...
            addLocation("Belfalas Islet", setName, 1, 5)
                .WithTraits("Coastland.", "Ocean.")
            ...
            addLocation("Cobas Haven", setName, 2, 4)
                .WithTraits("Coastland.", "Ocean.")
            ...
            addTreachery("Ramming Speed!", setName)
            ...
            addTreachery("Taking on Water", setName)
            ...
            addTreachery("The Raiders' Assault", setName)
            ...
            addObjective("Sea-ward Tower", setName)
                .WithUnique()
            ...
            addObjective("Tower of the Gull", setName)
                .WithUnique()
                .WithKeywords("Guarded.")
            ...
            addObjective("The Beacon", setName)
                .WithUnique()
                .WithKeywords("Guarded.")
            ...
            addObjective("Tower of the Heron", setName)
                .WithUnique()
                .WithKeywords("Guarded.")
