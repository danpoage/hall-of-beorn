...
namespace HallOfBeorn.Models.LotR.Sets.DreamChaser
{
    public class TheCityOfCorsairs : CardSet
    {
        ...
        protected override void Initialize()
        {
            ...
            addQuest("The Coast of Umbar", setCoast, 1, 'A', 15)
            ...
            addQuest("Fate of the Dream-chaser", setCoast, 2, 'A', Card.VALUE_NA)
            ...
            addQuest("The Haven of Umbar", setCity, 3, 'A', 18)
            ...
            addQuest("Final Confrontation", setCity, 4, 'A', Card.VALUE_NA)
            ...
            addEnemy("Stormcaller", setCoast, 20, 2, 6, 6, 18)
                .WithUnique()
            ...
            addShipEnemy("Slave Ship", setCoast, 32, 3, 7, 5, 5)
                .WithTraits("Corsair.", "Ship.")
                .WithKeywords("Boarding 1.")
            ...
            addEnemy("Umbar Slaver", setCoast, 28, 2, 2, 3, 5)
            ...
            addLocation("Southern Belfalas", setCoast, 3, 5)
            ...
            addLocation("Corsair Waters", setCoast, 4, 3)
                .WithTraits("Ocean.", "Coastland.")
            ...
            addLocation("White Tower", setCoast, 2, 3)
            ...
            addTreachery("Serpent's Tail", setCoast)
            ...
            addEnemy("Captain Sahír", setCity, 4, 6, 6, 2, 8)
                .WithUnique()
            ...
            addLocation("The Shattered Monument", setCity, 4, 8)
                .WithUnique()
                .WithTraits("Umbar.")
            ...
            addLocation("Streets of Umbar", setCity, 1, 5)
            ...
            addLocation("City of Corsairs", setCity, Card.VALUE_X, 4)
                .WithTraits("Umbar.", "City.")
            ...
            addLocation("Umbar Harbor", setCity, 4, 4)
                .WithTraits("Umbar.", "City.")
            ...
            addTreachery("Foes of Ecthelion", setCity)
            ...
            addTreachery("Umbar Patrol", setCity)
            ...
            addTreachery("Fury and Malice", setCity)
