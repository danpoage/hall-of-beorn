...
namespace HallOfBeorn.Models.LotR.Sets.DreamChaser
{
    public class TheCityOfCorsairs : CardSet
    {
        ...
        protected override void Initialize()
        {
            ...
            Cards.Add(LotRCard.Ally("Soldier of Dol Amroth", Sphere.Tactics, 2, 0, 1, 1, 2)
                .WithTraits("Gondor.", "Warrior.")
            ...
            Cards.Add(LotRCard.Ally("Súlien", Sphere.Spirit, 4, 3, 0, 2, 2)
                .WithUnique()
            ...
            Cards.Add(LotRCard.Ally("Guardian of Ithilien", Sphere.Lore, 1, 0, 1, 0, 1)
            ...
            Cards.Add(LotRCard.Quest("The Coast of Umbar", 1, setCoast, 15)
            ...
            Cards.Add(LotRCard.Quest("The Haven of Umbar", 3, setCity, 18)
