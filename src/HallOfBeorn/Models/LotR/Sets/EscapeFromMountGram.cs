...
namespace HallOfBeorn.Models.LotR.Sets
{
    public class EscapeFromMountGram : CardSet
    {
        protected override void Initialize()
        {
            ...
            Cards.Add(LotRCard.Hero("Rossiel", "", Sphere.Lore, 8, 2, 1, 2, 3)
                .WithTraits("Silvan.")
            ...
            Cards.Add(LotRCard.Event("Descendants of Kings", "", Sphere.Leadership, 1)
            ...
            Cards.Add(LotRCard.Event("Boomed and Trumpeted", "", Sphere.Tactics, 1)
                .WithTraits("Ent.")
            ...
            Cards.Add(LotRCard.PlayerSideQuest("Double Back", "", Sphere.Spirit, 0, 4)
            ...
            Cards.Add(LotRCard.Event("Leave No Trace", "", Sphere.Lore, 1)
            ...
            Cards.Add(LotRCard.Event("Distant Stars", "", Sphere.Lore, 0)
            ...
            Cards.Add(LotRCard.Location("Southern Gate", "", "Escape from Mount Gram", 3, 8)
                .WithUnique()
                .WithTraits("Mountain.")
            ...
            Cards.Add(LotRCard.Enemy("Cruel Torturer", "", "Escape from Mount Gram", 36, 2, 3, 2, 3)
                .WithTraits("Goblin.", "Orc.")
            ...
            Cards.Add(LotRCard.Enemy("Dungeon Guard", "", "Escape from Mount Gram", 16, 1, 2, 1, 2)
                .WithTraits("Goblin.", "Orc.")
                .WithKeywords("Capture 1.")
            ...
            Cards.Add(LotRCard.Location("Prison Cell", "", "Escape from Mount Gram", 1, 3)
            ...
            Cards.Add(LotRCard.Location("Patrol Room", "", "Escape from Mount Gram", 3, 2)
                .WithTraits("Underground.")
            ...
            Cards.Add(LotRCard.Treachery("Sound the Alarm!", "", "Escape from Mount Gram")
            ...
            Cards.Add(LotRCard.Treachery("Feeble and Weary", "", "Escape from Mount Gram")
            ...
            Cards.Add(LotRCard.Treachery("Interrogation", "", "Escape from Mount Gram")
            ...
            Cards.Add(LotRCard.EncounterSideQuest("Stop the Executioners!", "", "Escape from Mount Gram", 6)
