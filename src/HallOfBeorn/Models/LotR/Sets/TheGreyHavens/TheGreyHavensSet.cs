...
namespace HallOfBeorn.Models.LotR.Sets.TheGreyHavens
{
    public class TheGreyHavensSet : CardSet
    {
        protected override void Initialize()
        {
            ...
            Cards.Add(LotRCard.Hero("Galdor of the Havens", "", Sphere.Lore, 9, 2, 2, 1, 4)
                .WithTraits("Noldor.")
            ...
            Cards.Add(LotRCard.Event("Skyward Volley", "", Sphere.Tactics, 2)
            ...
            Cards.Add(LotRCard.Attachment("Grappling Hook", "", Sphere.Tactics, 1)
                .WithTraits("Item.")
            ...
            Cards.Add(LotRCard.Event("Anchor Watch", "", Sphere.Leadership, 2)
            ...
            Cards.Add(LotRCard.Attachment("Mariner's Compass", "", Sphere.Leadership, 1)
                .WithTraits("Item.")
            ...
            Cards.Add(LotRCard.Event("The Evening Star", "", Sphere.Lore, 2)
            ...
            Cards.Add(LotRCard.Event("Elwing's Flight", "", Sphere.Spirit, 2)
            ...
            Cards.Add(LotRCard.Attachment("To the Sea, to the Sea!", "", Sphere.Spirit, 1)
                .WithUnique()
                .WithTraits("Song.")
            ...
            Cards.Add(LotRCard.Attachment("Narya", "", Sphere.Neutral, 2)
                .WithUnique()
            ...
            Cards.Add(LotRCard.Location("Starlit Sea", "", "Voyage Across Belegaer", 3, 2)
                .WithTraits("Ocean.")
            ...
            Cards.Add(LotRCard.Location("Fog Bank", "", "Voyage Across Belegaer", 2, 5)
                .WithTraits("Ocean.")
            ...
            Cards.Add(LotRCard.ObjectiveAlly("Calphon", "", "The Fate of Númenor", 1, 0, 1, 3)
                .WithUnique()
            ...
            Cards.Add(LotRCard.Enemy("Servant of the Deceiver", "", "The Fate of Númenor", 35, 3, 3, 4, 3)
                .WithTraits("Undead.")
            ...
            Cards.Add(LotRCard.Location("Steep Plateau", "", "The Fate of Númenor", 1, 3)
                .WithTraits("Coastland.")
            ...
            Cards.Add(LotRCard.Treachery("Mysterious Fog", "", "The Fate of Númenor")
            ...
            Cards.Add(LotRCard.Treachery("Lingering Malevolence", "", "The Fate of Númenor")
            ...
            Cards.Add(LotRCard.Treachery("Ruins of Ages Past", "", "The Fate of Númenor")
            ...
            Cards.Add(LotRCard.Enemy("Corsair Arsonist", "", "Raid on the Grey Havens", 28, 2, 2, 1, 3)
                .WithTraits("Corsair.")
            ...
            Cards.Add(LotRCard.Location("Mithlond Harbor", "", "Raid on the Grey Havens", 1, 2)
            ...
            Cards.Add(LotRCard.Location("Burning Piers", "", "Raid on the Grey Havens", 1, 3)
                .WithTraits("Grey Havens.")
            ...
            Cards.Add(LotRCard.Location("Pillaged Ship", "", "Raid on the Grey Havens", 2, 4)
                .WithTraits("Grey Havens.", "Ship.")
                .WithKeywords("Aflame 5.")
            ...
            Cards.Add(LotRCard.Location("White Ship", "", "Raid on the Grey Havens", 4, 6)
                .WithTraits("Grey Havens.", "Ship.")
            ...
            Cards.Add(LotRCard.Location("Elven Wave-runner", "", "Raid on the Grey Havens", 3, 3)
                .WithTraits("Grey Havens.", "Ship.")
            ...
            Cards.Add(LotRCard.Location("Elven Caravel", "", "Raid on the Grey Havens", 3, 5)
                .WithTraits("Grey Havens.", "Ship.")
                .WithKeywords("Aflame 4.")
            ...
            Cards.Add(LotRCard.Treachery("Put to the Torch", "", "Raid on the Grey Havens")
            ...
            Cards.Add(LotRCard.Treachery("The Fires Spread", "", "Raid on the Grey Havens")
                .WithKeywords("Doomed 2.")
            ...
            Cards.Add(LotRCard.Location("Calm Waters", "", "Vast Oceans", 1, 4)
                .WithTraits("Ocean.")
            ...
            Cards.Add(LotRCard.Location("Rolling Seas", "", "Vast Oceans", 4, 3)
                .WithTraits("Ocean.")
            ...
            Cards.Add(LotRCard.Treachery("Thrown Off Course", "", "Vast Oceans")
            ...
            Cards.Add(LotRCard.Location("Rough Waters", "", "Stormy Weather", 2, 3)
                .WithTraits("Ocean.")
            ...
            Cards.Add(LotRCard.Location("Waterspout", "", "Stormy Weather", 2, 4)
                .WithTraits("Ocean.")
            ...
            Cards.Add(LotRCard.Treachery("Sudden Storms", "", "Stormy Weather")
                .WithTraits("Weather.")
            ...
            Cards.Add(LotRCard.Treachery("Winds of Wrath", "", "Stormy Weather")
                .WithTraits("Weather.")
            ...
            Cards.Add(LotRCard.ShipEnemy("Light Cruiser", "Umbar Fleet", 37, 4, 6, 5, 7)
                .WithTraits("Corsair.", "Ship.")
            ...
            Cards.Add(LotRCard.ShipEnemy("Corsair Warship", "Umbar Fleet", 44, 3, 8, 4, 9)
                .WithTraits("Corsair.", "Ship.")
            ...
            Cards.Add(LotRCard.Treachery("Boarding Party", "", "Umbar Fleet")
            ...
            Cards.Add(LotRCard.Enemy("Southron Sailor", "", "Corsair Pirates", 28, 0, 2, 1, 4)
                .WithTraits("Corsair.")
            ...
            Cards.Add(LotRCard.Enemy("Cunning Pirate", "", "Corsair Pirates", 36, 1, 2, 2, 4)
                .WithTraits("Corsair.", "Raider.")
            ...
            Cards.Add(LotRCard.Enemy("Vicious Marauder", "", "Corsair Pirates", 12, 2, 3, 3, 3)
                .WithTraits("Corsair.", "Raider.")
            ...
            Cards.Add(LotRCard.Enemy("Umbar Captain", "", "Corsair Pirates", 40, 4, 5, 3, 5)
                .WithTraits("Corsair.")
            ...
            Cards.Add(LotRCard.Enemy("Umbar Raider", "", "Corsair Raiders", 24, 2, 3, 2, 4)
                .WithTraits("Corsair.", "Raider.")
            ...
            Cards.Add(LotRCard.Enemy("Corsair Infiltrator", "", "Corsair Raiders", 16, 2, 3, 3, 2)
                .WithTraits("Corsair.", "Raider.")
            ...
            Cards.Add(LotRCard.Enemy("Raid Leader", "", "Corsair Raiders", 40, 3, 5, 1, 5)
                .WithTraits("Corsair.", "Raider.")
            ...
            Cards.Add(LotRCard.Treachery("Battle-Hardened", "", "Corsair Raiders")
            ...
            Cards.Add(LotRCard.Enemy("Drowned Dead", "", "Drowned Dead", 32, 2, 4, 3, 3)
                .WithTraits("Undead.")
            ...
            Cards.Add(LotRCard.Enemy("Soulless Cadaver", "", "Drowned Dead", 38, 3, 3, 2, 4)
                .WithTraits("Undead.")
            ...
            Cards.Add(LotRCard.Enemy("Throngs of Unfaithful", "", "Drowned Dead", 26, 1, 2, 0, 4)
                .WithTraits("Undead.")
                .WithKeywords("Surge.")
            ...
            Cards.Add(LotRCard.Treachery("Curse of the Downfallen", "", "Drowned Dead")
            ...
            Cards.Add(LotRCard.Treachery("Aimless Wandering", "", "Ruins of Númenor")
            ...
            Cards.Add(LotRCard.Enemy("Na'asiyah", "", "The Stormcaller Elite", 8, 1, 2, 2, 4)
                .WithSuffix("Enemy")
                .WithUnique()
                .WithTraits("Corsair.", "Raider.")
            ...
            Cards.Add(LotRCard.ObjectiveAlly("Na'asiyah", "", "The Stormcaller Elite", 1, 2, 2, 4)
                .WithSuffix("Objective-Ally")
                .WithUnique()
                .WithTraits("Corsair.", "Raider.")
