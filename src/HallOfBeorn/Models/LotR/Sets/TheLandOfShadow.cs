...
namespace HallOfBeorn.Models.LotR.Sets
{
    public class TheLandOfShadow : CardSet
    {
        protected override void Initialize()
        {
            ...
            Cards.Add(LotRCard.Event("In the Shadows", "", Sphere.Lore, 3)
            ...
            Cards.Add(LotRCard.Event("Speak Your Promise!", "", Sphere.Fellowship, 1)
            ...
            Cards.Add(LotRCard.Enemy("Groping Dead", "", "The Passage of the Marshes", 24, 2, 3, 1, 4)
                .WithTraits("Undead.")
            ...
            Cards.Add(LotRCard.Enemy("Dead Things", "", "The Passage of the Marshes", 32, 3, 4, 2, 5)
                .WithTraits("Undead.")
            ...
            Cards.Add(LotRCard.Enemy("Candle-bearer", "", "The Passage of the Marshes", 36, 3, 5, 2, 6)
                .WithTraits("Undead.")
            ...
            Cards.Add(LotRCard.Location("Evil-smelling Fens", "", "The Passage of the Marshes", 3, 4)
                .WithTraits("Marsh.")
                .WithKeywords("Mire 3.")
            ...
            Cards.Add(LotRCard.Location("Shifting Quagmire", "", "The Passage of the Marshes", 1, 3)
                .WithTraits("Marsh.")
            ...
            Cards.Add(LotRCard.Location("Haunted Mere", "", "The Passage of the Marshes", 4, 5)
                .WithTraits("Marsh.")
                .WithKeywords("Mire 2.")
            ...
            Cards.Add(LotRCard.Location("Stagnant Pools", "", "The Passage of the Marshes", 3, 7)
                .WithTraits("Marsh.")
                .WithKeywords("Mire 5.")
            ...
            Cards.Add(LotRCard.Location("Soft Mires", "", "The Passage of the Marshes", 2, 4)
                .WithTraits("Marsh.")
                .WithKeywords("Mire 1.")
            ...
            Cards.Add(LotRCard.Treachery("Bitter Reek", "", "The Passage of the Marshes")
                .WithKeywords("Peril.")
            ...
            Cards.Add(LotRCard.Treachery("A Fell Light", "", "The Passage of the Marshes")
                .WithKeywords("Peril.")
            ...
            Cards.Add(LotRCard.Location("The Cross-roads", "", "Journey to the Cross-roads", 9, 9)
                .WithUnique()
                .WithTraits("Road.")
            ...
            Cards.Add(LotRCard.Location("Ithilien Woods", "", "Journey to the Cross-roads", 2, 3)
                .WithTraits("Forest.")
            ...
            Cards.Add(LotRCard.Location("Hills of Ithilien", "", "Journey to the Cross-roads", 2, 4)
            ...
            Cards.Add(LotRCard.Treachery("Marching Up the Road", "", "Journey to the Cross-roads")
            ...
            Cards.Add(LotRCard.Treachery("Fierce Southrons", "", "Journey to the Cross-roads")
                .WithKeywords("Peril.")
            ...
            Cards.Add(LotRCard.Enemy("Morgul Orc", "", "Shelob's Lair", 35, 1, 3, 2, 3)
                .WithTraits("Orc.", "Uruk.")
                .WithKeywords("Peril.")
            ...
            Cards.Add(LotRCard.Enemy("Orc of Cirith Ungol", "", "Shelob's Lair", 40, 2, 4, 2, 5)
                .WithTraits("Orc.", "Uruk.")
                .WithKeywords("Peril.")
            ...
            Cards.Add(LotRCard.Location("Morgul Vale", "", "Shelob's Lair", 4, 2)
                .WithUnique()
                .WithTraits("Vale.")
            ...
            Cards.Add(LotRCard.Location("Cleft of Cirith Ungol", "", "Shelob's Lair", 4, 4)
                .WithUnique()
                .WithTraits("Mountain.")
            ...
            Cards.Add(LotRCard.Location("The Spider's Lair", "", "Shelob's Lair", 3, 4)
            ...
            Cards.Add(LotRCard.Location("The Under-way", "", "Shelob's Lair", 2, 3)
                .WithTraits("Underground.")
            ...
            Cards.Add(LotRCard.Location("Deep Dark Passage", "", "Shelob's Lair", 2, 5)
                .WithTraits("Underground.")
            ...
            Cards.Add(LotRCard.Location("Den of Night", "", "Shelob's Lair", 1, 4)
                .WithTraits("Underground.")
            ...
            Cards.Add(LotRCard.Treachery("Exhalation of Decay", "", "Shelob's Lair")
            ...
            Cards.Add(LotRCard.Treachery("Call of the Ring", "", "Morgul Nazgûl")
            ...
            Cards.Add(LotRCard.Treachery("We Hates Them!", "", "Gollum")
                .WithKeywords("Surge.")
            ...
            Cards.Add(LotRCard.Enemy("Oliphaunt", "", "Men of Harad", 44, 3, 6, 2, 9)
            ...
            Cards.Add(LotRCard.Enemy("Haradrim Soldier", "", "Men of Harad", 40, 2, 4, 3, 4)
                .WithTraits("Harad.")
            ...
            Cards.Add(LotRCard.Location("Blocked Tunnel", "", "The Great Spider", 3, 9)
                .WithTraits("Underground.")
            ...
            Cards.Add(LotRCard.Treachery("Lurking Malice", "", "The Great Spider")
            ...
            Cards.Add(LotRCard.Treachery("Rage and Hunger", "", "The Great Spider")
