...
namespace HallOfBeorn.Models.LotR.Sets
{
    public class TheLostRealm : CardSet
    {
        protected override void Initialize()
        {
            ...
            Cards.Add(LotRCard.Quest("Stop the War Party", "8486ABBA-3515-49DE-A404-CAADD158396A", 1, 1, "Intruders in Chetwood", 30)
            ...
            Cards.Add(LotRCard.Quest("Scattered Among the Hills", "B023E649-14C9-48E1-B98B-982551391D94", 2, 1, "The Weather Hills", 255)
            ...
            Cards.Add(LotRCard.Quest("Cornered Animals", "D1D67AFA-A946-4E30-B5DC-135146FF419B", 2, 2, "The Weather Hills", 20)
            ...
            Cards.Add(LotRCard.Quest("The Shades of Angmar", "C055DDF4-A4E3-4813-B133-44A244F7F5C5", 3, 1, "Deadmen's Dike", 11)
            ...
            Cards.Add(LotRCard.Quest("A Fell Wraith", "5A6AA33F-82EA-407F-BC2D-AD3B2E0D8C43", 3, 2, "Deadmen's Dike", 13)
