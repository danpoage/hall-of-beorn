    ...
    public class TheBattleofLakeTown : CardSet
    {
        protected override void Initialize()
        {
            ...
            Cards.Add(new LotRCard()
            {
                ...
                Quantity = 1,
                IsUnique = true,
                Text = "Guarded.\r\nAction: Exhaust a hero to claim this objective and attach it to that hero when it is free of encounters. (Counts as an attachment with the text:'If detached discard The Old ThrushResponse: After attached hero exhausts to attack Smaug, discard X cards from hand to reduce Smaug's Defense by X.')",
