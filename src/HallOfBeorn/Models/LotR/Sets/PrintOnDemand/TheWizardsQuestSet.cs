...
namespace HallOfBeorn.Models.LotR.Sets.PrintOnDemand
{
    public class TheWizardsQuestSet : CardSet
    {
        ...
        protected override void Initialize()
        {
            ...
            addQuest("Mirkwood Forest", setName, 2, 'A', 0)
            ...
            addQuest("The Necromancer's Tower", setName, 3, 'A', 0)
                ...
                .WithInfo(6, 1, Artist.Ben_Zweifel);
            addQuest("The Tower of Sorcery", setName, 3, 'A', 20)
                ...
                .WithInfo(7, 1, Artist.Julian_Kok);
            addQuest("Return to Rhosgobel", setName, 3, 'A', 10)
            ...
            addEnemy("Nazgûl of Dol Guldur", string.Empty, 36, 3, 6, 3, 9)
                ...
                .WithInfo(0, 1, Artist.David_A_Nash);
            addLocation("Necromancer's Pass", string.Empty, 2, 2)
                ...
                .WithInfo(0, 1, Artist.Daryl_Mandryk);
            ...
            addLocation("Twilight Hall", string.Empty, 0, 6)
                ...
                .WithInfo(0, 1, Artist.Katy_Grierson);
            ...
            addTreachery("Under the Shadow", string.Empty)
                ...
                .WithInfo(0, 0, Artist.Igor_Kieryluk);
            addEnemy("Necromancer's Warg", string.Empty, 21, 2, 2, 1, 2)
                ...
                .WithInfo(0, 1, Artist.Guillaume_Ducos);
            ...
            addLocation("The Sorcerer's Tower", string.Empty, 4, 4)
                ...
                .WithInfo(0, 1, Artist.Julian_Kok);
            ...
            addEnemy("Hill Troll", string.Empty, 33, 1, 6, 2, 8)
                ...
                .WithInfo(0, 1, Artist.Florian_Stitz);
            ...
            addEnemy("Hunting Warg", string.Empty, 32, 2, 3, 2, 4)
                ...
                .WithInfo(0, 1, Artist.Aurelien_Hubert);
            ...
            addEnemy("Ravenous Spider", string.Empty, 34, 3, 4, 2, 5)
                ...
                .WithInfo(0, 1, Artist.Alvaro_Calvo_Escudero);
            addTreachery("Nightfall", string.Empty)
                ...
                .WithInfo(0, 1, Artist.David_Lecossu);
            addEnemy("Venomous Spider", string.Empty, 28, 2, 3, 2, 4)
                ...
                .WithInfo(0, 1, Artist.Florian_Devos);
            ...
            addEnemy("Howling Warg", string.Empty, 23, 1, 2, 1, 3)
                ...
                .WithInfo(0, 1, Artist.Dylan_Pierpont);
            addLocation("The Wargs' Glade", string.Empty, 3, 5)
                ...
                .WithInfo(0, 1, Artist.Michael_Rasmussen);
