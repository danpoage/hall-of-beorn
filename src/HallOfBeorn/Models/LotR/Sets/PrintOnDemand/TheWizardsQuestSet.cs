    ...
    public class TheWizardsQuestSet : CardSet
    {
        ...
        protected override void Initialize()
        {
            ...
            addQuest("Radagast's Request", setName, 1, 'A', 10)
                ...
                .WithOppositeText("Forced: When Rhosgobel is explored, flip it over and add Rider of Mirkwood to the staging area.\r\nThis stage cannot be defeated while Rhosgobel is in play.")
                .WithInfo(1, 1, Artist.Unknown);
            
            addQuest("Mirkwood Forest", setName, 2, 'A', 5)
                .WithFlavor("Radagast asks that you travel to Dol Guldur to measure the Enemy's strength there. The Anduin vale is too closely watched, so you make your way through the perils of Mirkwood forest.")
                .WithText("When Revealed: The opposing team searches the top 5 cards of the encounter deck for a card with 1 or less (cost 2 or less if there are two or more players), set it aside, and shufles the encounter deck. Reveal the set aside card. Its 'when revealed' effects cannot be canceled.")
                .WithOppositeTitle("A Fork in the Road")
                .WithOppositeText("When Revealed: The opposing team searches the encounter deck and discard pile for a location with cost 2 or less, adds it to the staging area, and places a resource on it. Shuffle the encounter deck.\r\nThe location with a resource on it is immune to player card effects and the players cannot travel to it while this stage has any quest points remaining. This stage cannot be defeated while the location with a resource on it is in play.")
            ...
            addQuest("Mirkwood Forest", setName, 2, 'A', 20)
                ...
                .WithOppositeText("When Revealed: The opposing team chooses an ally controlled by each player and places them faceup under this stge as guarded objectives with blank text boxes.\r\nPlayers cannot play or put into play any ally that shares a title with an ally guarded by this stage. When this stage is defeated, return each guarded ally to its owner's hand.")
            ...
            addQuest("The Necromancer's Tower", setName, 3, 'A', 20)
                .WithFlavor("The dark form of Dol Guldur rises up ahead. The servants of the Enemy patrol the surrounding woods. You must take great care to gather what information you can and return with news to Rhosgobel before it's too late.")
                .WithText("When Revealed: The opposing team searches the top 5 cards of the encounter deck for a card with cost 2 or less (3 or less if there are two or more players), sets it aside, and shuffles the encounter deck. Reveal the set aside card. Its 'when revealed' effects cannot be canceled.")
                .WithOppositeTitle("The Tower of Sorcery")
                .WithOppositeText("Forced: After the players have committed characters to the quest, discard cards from the top of the encounter deck until a treachery is discarded. Reveal that treachery.\r\nIf the players defeat this stage, they win the game.")
            ...
            addQuest("The Necromancer's Tower", setName, 3, 'A', 15)
                ...
                .WithOppositeText("When Revealed: Shuffle the encounter discard pile into the encounter deck. Each player discards from the top of the encounter deck until he discards an enemy, adds that enemy to the staging area, and attached a hero he controls to it as a guarded objective (discard all tokens from the chosen hero).\r\nIf there is an unguarded hero in the staging area, return it to its owner's control, exhausted. This stage cannot be defeated while there is a guarded objective in play. If the players defeat this stage, they win the game.")
            ...
            addEnemy("Forest Flies", string.Empty, 6, 2, 1, 1, 6)
                ...
                .WithText("Forced: When Forest Flies attacks, raise the defending player's threat by 1.")
            ...
            addEnemy("Necromancer's Warg", string.Empty, 21, 2, 2, 1, 2)
                ...
                .WithTraits("Warg.")
                .WithText("Forced: After Necromancer's Warg engages you, deal 1 damage to a character you control.")
            ...
            addEnemy("Dol Guldur Beastmaster", string.Empty, 35, 2, 4, 2, 5)
                ...
                .WithTraits("Orc.")
                .WithText("Forced: After Dol Guldur Beastmaster engages you, the opposing team searches the encounter deck and discard pile for a Necromancer's Warg and puts it into play engaged with you. Shuffle the enconter deck.")
            ...
            addEnemy("Spider of Dol Guldur", string.Empty, 35, 3, 5, 2, 6)
                ...
                .WithTraits("Spider.")
                .WithText("Forced: After Spider of Dol Guldur attacks and destroys an ally, return it to the staging area.")
            ...
            addLocation("Patch of Midnight", string.Empty, 4, 4)
                ...
                .WithTraits("Forest.")
                .WithText("Forced: At the beginning of the staging step, discard Patch of Midnight and reveal the top card of the encounter deck.")
            ...
            addTreachery("Eyes in the Dark", string.Empty)
                ...
                .WithText("When Revealed: The opposing team chooses a questing character controlled by each player. Ready each chosen character and remove them from the quest.")
            ...
            addEnemy("Hill Troll", string.Empty, 33, 1, 6, 2, 8)
                ...
                .WithTraits("Troll.")
                .WithText("Cannot have non-objective palyer card attachments.")
            ...
            addTreachery("Befouled Equipment", string.Empty)
                ...
                .WithText("When Revealed: Attack to the character with the most attachments without Befouled Equipment attached. (Counts as a Condition attachment with the text: \"Forced: At the end of the round, discard an attachment from attached character. Befouled Equipment cannot be discarded this way unless it is the only attachment on attached character.\")")
                .WithInfo(36, 1, Artist.Ed_Mattinian);
            addEnemy("Hunting Warg", string.Empty, 32, 2, 3, 2, 4)
                .WithSetNumberAndCost(23, 1)
                .WithTraits("Warg.")
                .WithText("Forced: After Hunting Warg engages a player, it makes an immediate attack. If Hunting Warg is dealt a shadow card with no shadow effect for this attack, it gets +2 Attack until the end of the phase.")
                .WithInfo(37, 1, Artist.Aurelien_Hubert);
            addLocation("Hunter's Lookout", string.Empty, 3, 4)
                .WithSetNumberAndCost(23, 1)
                .WithTraits("Mountain.", "Forest.")
                .WithText("While Hunter's Lookout is in the staging area, it gains: \"Forced: At the end of the round, raise each player's threat by 1 for each enemy in the staging area.\"\r\nTravel: The highest Attack enemy in the staging area makes an immediate attack against the first player.")
                .WithInfo(38, 1, Artist.Unknown);
            addTreachery("Restless Hunters", string.Empty)
                .WithSetNumberAndCost(23, 0)
                .WithText("When Revealed: Return each engaged enemy to the staging area. If no enemies were returned this way, Restless Hunters gains surge.")
            ...
            addEnemy("Dol Guldur Orcs", string.Empty, 24, 2, 3, 1, 4)
                ...
                .WithTraits("Orc.")
                .WithText("When Revealed: Each player deals 1 damage to a character he controls.")
            ...
            addLocation("The Shadow Road", string.Empty, 3, 3)
                ...
                .WithText("While The Shadow Road is in the staging area, it gains: \"Forced: After a player optionally engages an enemy, he deals 1 damage to a character he controls.\"\r\nTravel: Each player deals 1 damage to a character he controls.")
            ...
            addEnemy("Ravenous Spider", string.Empty, 34, 3, 4, 2, 5)
                ...
                .WithTraits("Spider.")
                .WithText("Forced: After Ravenous Spider attacks and destroys a character, the defending player exhausts a character he controls.")
            ...
            addLocation("Forest Gate", string.Empty, 1, 5)
                ...
                .WithTraits("Forest.")
                .WithText("Forest Gate gets +1 Threat for each enemy in the staging area.")
            ...
            addLocation("Pitch-dark Thicket", string.Empty, 2, 3)
                ...
                .WithTraits("Forest.")
                .WithText("While Pitch-dark Thicket is in the staging area, enemies in the staging area cannot take damage.")
            ...
            addTreachery("Fastness of Mirkwood", string.Empty)
                .WithSetNumberAndCost(26, 1)
                .WithText("When Revealed: The opposing team searches the encounter deck and discard pile for one different 0 cost location per player (limit 2) and adds them to the staging area. Shuffle the encounter deck.")
            ...
            addEnemy("Dark Bats", string.Empty, 20, 2, 3, 1, 2)
                ...
                .WithTraits("Creature.")
                .WithText("Forced: After Dark Bats attacks and damages a character, reveal the top card of the encounter deck. Then, discard Dark Bats.")
            ...
            addLocation("Forest Stream", string.Empty, 2, 5)
                ...
                .WithText("While Forest Stream is in the staging area, it gains: \"Forced: At the end of the round, remove 2 progress from the main quest.\"\r\nTravel: Raise each player's threat by 2.")
            ...
            addEnemy("Howling Warg", string.Empty, 23, 1, 2, 1, 3)
                ...
                .WithTraits("Warg.")
                .WithText("When Revealed: Discard the top card of the encounter deck. If that card has the Warg trait, reveal it and add it to the staging area.")
