        ...
        : CardSet
    {
        ...
        protected override void Initialize()
        {
            ...
            addAttachment("Protector of Lórien", 1, Sphere.Lore, false)
                ...
                .WithFlavorLine("'Speak no evil of the lady Galadriel!' said Aragorn sternly. 'There is in her and in this land no evil, unless a man bring it hither himself. Then let him beware.'")
            ...
            addEnemy("King Spider", EncounterSet.SpidersOfMirkwoodCampaign, 20, 2, 3, 1, 3)
            ...
            addEnemy("Hummerhorns", EncounterSet.SpidersOfMirkwoodCampaign, 40, 1, 2, 0, 3)
            ...
            addEnemy("Ungoliant's Spawn", EncounterSet.SpidersOfMirkwoodCampaign, 32, 3, 5, 2, 9)
                .WithTraits("Creature.", "Spider.")
            ...
            addLocation("Great Forest Web", EncounterSet.SpidersOfMirkwoodCampaign, 2, 2)
                .WithTraits("Forest.")
            ...
            addLocation("Mountains of Mirkwood", EncounterSet.SpidersOfMirkwoodCampaign, 2, 3)
            ...
            addTreachery("Eyes of the Forest", EncounterSet.SpidersOfMirkwoodCampaign)
            ...
            addTreachery("Caught in a Web", EncounterSet.SpidersOfMirkwoodCampaign)
            ...
            addEnemy("Wolf Rider", EncounterSet.WilderlandsCampaign, 10, 1, 2, 0, 2)
            ...
            addEnemy("Hill Troll", EncounterSet.WilderlandsCampaign, 30, 1, 6, 3, 9)
                .WithTraits("Troll.")
            ...
            addEnemy("Goblin Sniper", EncounterSet.WilderlandsCampaign, 48, 2, 2, 0, 2)
                .WithTraits("Goblin.", "Orc.")
            ...
            addEnemy("Marsh Adder", EncounterSet.WilderlandsCampaign, 40, 3, 4, 1, 7)
                .WithTraits("Creature.")
            ...
            addEnemy("Wargs", EncounterSet.WilderlandsCampaign, 20, 2, 3, 1, 3)
                .WithTraits("Creature.")
            ...
            addTreachery("Despair", EncounterSet.WilderlandsCampaign)
            ...
            addLocation("The Brown Lands", EncounterSet.WilderlandsCampaign, 5, 1)
            ...
            addLocation("The East Bight", EncounterSet.WilderlandsCampaign, 1, 6)
                .WithTraits("Wasteland.")
            ...
            addEnemy("Dol Guldur Orcs", EncounterSet.DolGuldurOrcsCampaign, 10, 2, 2, 0, 3)
            ...
            addEnemy("Chieftan Ufthak", EncounterSet.DolGuldurOrcsCampaign, 35, 2, 3, 3, 6)
                .WithTraits("Dol Guldur.", "Orc.")
            ...
            addEnemy("Dol Guldur Beastmaster", EncounterSet.DolGuldurOrcsCampaign, 35, 2, 3, 1, 5)
                .WithTraits("Dol Guldur.", "Orc.")
            ...
            addTreachery("Driven by Shadow", EncounterSet.DolGuldurOrcsCampaign)
            ...
            addTreachery("The Necromancer's Reach", EncounterSet.DolGuldurOrcsCampaign)
            ...
            addLocation("Necromancer's Pass", EncounterSet.DolGuldurOrcsCampaign, 3, 2)
            ...
            addLocation("Enchanted Stream", EncounterSet.DolGuldurOrcsCampaign, 2, 2)
                .WithTraits("Forest.")
            ...
            addEnemy("Forest Spider", EncounterSet.PassageThroughMirkwoodCampaign, 25, 2, 2, 1, 4)
                .WithTraits("Creature.", "Spider.")
            ...
            addEnemy("East Bight Patrol", EncounterSet.PassageThroughMirkwoodCampaign, 5, 3, 3, 1, 2)
                .WithTraits("Goblin.", "Orc.")
            ...
            addEnemy("Black Forest Bats", EncounterSet.PassageThroughMirkwoodCampaign, 15, 1, 1, 0, 2)
                .WithTraits("Creature.")
            ...
            addLocation("Old Forest Road", EncounterSet.PassageThroughMirkwoodCampaign, 1, 3)
                .WithTraits("Forest.")
            ...
            addLocation("Forest Gate", EncounterSet.PassageThroughMirkwoodCampaign, 2, 4)
                .WithTraits("Forest.")
            ...
            addEnemy("Dungeon Jailor", EncounterSet.EscapeFromDolGuldurCampaign, 38, 1, 2, 3, 5)
                .WithTraits("Dol Guldur.", "Orc.")
            ...
            addEnemy("Nazgûl of Dol Guldur", EncounterSet.EscapeFromDolGuldurCampaign, 40, 5, 4, 3, 9)
                .WithTraits("Nazgûl.")
            ...
            addEnemy("Cavern Guardian", EncounterSet.EscapeFromDolGuldurCampaign, 8, 2, 2, 1, 2)
                .WithTraits("Undead.")
            ...
            addTreachery("Under the Shadow", EncounterSet.EscapeFromDolGuldurCampaign)
            ...
            addTreachery("Iron Shackles", EncounterSet.EscapeFromDolGuldurCampaign)
            ...
            addLocation("Endless Caverns", EncounterSet.EscapeFromDolGuldurCampaign, 1, 3)
                .WithTraits("Dungeon.")
            ...
            addLocation("Tower Gate", EncounterSet.EscapeFromDolGuldurCampaign, 2, 1)
                .WithTraits("Dungeon.")
            ...
            addObjective("Gandalf's Map", EncounterSet.EscapeFromDolGuldurCampaign)
                .WithTraits("Item.")
            ...
            addObjective("Dungeon Torch", EncounterSet.EscapeFromDolGuldurCampaign)
                .WithTraits("Item.")
                .WithKeywords("Guarded.", "Restricted.")
                .WithTextLine("Guarded. Restricted.")
            ...
            addObjective("Shadow Key", EncounterSet.EscapeFromDolGuldurCampaign)
                .WithTraits("Item.")
                .WithKeywords("Guarded.", "Restricted.")
                .WithTextLine("Guarded. Restricted.")
            ...
            addEnemy("Misty Mountain Goblins", EncounterSet.JourneyAlongTheAnduinCampaign, 15, 2, 2, 1, 3)
            ...
            addTreachery("Massing at Night", EncounterSet.JourneyAlongTheAnduinCampaign)
                .WithAlternateEncounterSet("Journey Down the Anduin")
            ...
            addLocation("Banks of the Anduin", EncounterSet.JourneyAlongTheAnduinCampaign, 1, 3)
                .WithAlternateEncounterSet("Journey Down the Anduin")
            ...
            addLocation("Gladden Fields", EncounterSet.JourneyAlongTheAnduinCampaign, 3, 3)
                .WithAlternateEncounterSet("Journey Down the Anduin")
            ...
            addEnemy("Eastern Crows", EncounterSet.SauronsReachCampaign, 30, 1, 1, 0, 1)
                .WithTraits("Creature.")
                .WithKeywords("Surge.")
                .WithTextLine("Surge.")
            ...
            addTreachery("Evil Storm", EncounterSet.SauronsReachCampaign)
            ...
            addTreachery("Pursued by Shadow", EncounterSet.SauronsReachCampaign)
            ...
            addTreachery("Treacherous Fog", EncounterSet.SauronsReachCampaign)
            ...
            addQuest("Flies and Spiders", EncounterSet.PassageThroughMirkwoodCampaign, 1, 'A', 8)
                .WithIncludedEncounterSets(EncounterSet.DolGuldurOrcsCampaign, EncounterSet.SpidersOfMirkwood)
            ...
            addQuest("A Fork in the Road", EncounterSet.PassageThroughMirkwoodCampaign, 2, 'A', 2)
                .WithIncludedEncounterSets(EncounterSet.DolGuldurOrcsCampaign, EncounterSet.SpidersOfMirkwood)
            ...
            addQuest("A Chosen Path", EncounterSet.PassageThroughMirkwoodCampaign, 3, 'A', 0)
                .WithIncludedEncounterSets(EncounterSet.DolGuldurOrcsCampaign, EncounterSet.SpidersOfMirkwood)
            ...
            addQuest("A Chosen Path", EncounterSet.PassageThroughMirkwoodCampaign, 3, 'A', 10)
                .WithIncludedEncounterSets(EncounterSet.DolGuldurOrcsCampaign, EncounterSet.SpidersOfMirkwood)
                .WithFlavor("The trail winds into one of the darkest, most tangled parts of the forest...\r\n\r\nYou sense that foul, dark presence is hunting you, and you move quickly in an attempt to avoid its evil.")
            ...
            addQuest("The Necromancer's Tower", EncounterSet.EscapeFromDolGuldurCampaign, 1, 'A', 9)
                .WithIncludedEncounterSets(EncounterSet.DolGuldurOrcsCampaign, EncounterSet.SpidersOfMirkwood)
            ...
            addQuest("Through the Caverns", EncounterSet.EscapeFromDolGuldurCampaign, 2, 'A', 15)
                .WithIncludedEncounterSets(EncounterSet.DolGuldurOrcsCampaign, EncounterSet.SpidersOfMirkwood)
            ...
            addQuest("Out of the Dungeons", EncounterSet.EscapeFromDolGuldurCampaign, 3, 'A', 7)
                .WithIncludedEncounterSets(EncounterSet.DolGuldurOrcsCampaign, EncounterSet.SpidersOfMirkwood)
            ...
            addQuest("To the River...", EncounterSet.JourneyAlongTheAnduinCampaign, 1, 'A', 8)
                .WithIncludedEncounterSets(EncounterSet.DolGuldurOrcsCampaign, EncounterSet.SauronsReach, EncounterSet.Wilderlands)
                .WithAlternateEncounterSet("Journey Down the Anduin")
            ...
            addQuest("Anduin Passage", EncounterSet.JourneyAlongTheAnduinCampaign, 2, 'A', 16)
                .WithIncludedEncounterSets(EncounterSet.DolGuldurOrcsCampaign, EncounterSet.SauronsReach, EncounterSet.Wilderlands)
                .WithAlternateEncounterSet("Journey Down the Anduin")
            ...
            addQuest("Ambush on the Shore", EncounterSet.JourneyAlongTheAnduinCampaign, 3, 'A', 0)
                .WithIncludedEncounterSets(EncounterSet.DolGuldurOrcsCampaign, EncounterSet.SauronsReach, EncounterSet.Wilderlands)
                .WithAlternateEncounterSet("Journey Down the Anduin")
            ...
            addCampaign("Passage Through Mirkwood", EncounterSet.PassageThroughMirkwoodCampaign, "Mirkwood Paths - Part 1")
                .WithTextLine("You are playing Campaign Mode.")
                .WithTextLine("Setup: Put Mendor into play.")
                .WithTextLine("If Mendor leaves play, the players lose the game.")
                .WithFlavorLine("King Thranduil has assigned a guide, Mendor, to assist you in your passage through Mirkwood Forest.")
                .WithOppositeTextLine("Resolution: Each player earns 1 copy of the Mendor's Support boon crd. Add the earned cards to the Campaign Pool.")
                .WithOppositeTextLine("If Stage 3B was Beorn's Path, add the Ungoliant's Swarm burden card to the Campaign Pool.")
                .WithOppositeTextLine("If Stage 3B was Don't Leave the Path, add the Lingering Venom burden card to the Campaign Pool.")
                .WithOppositeFlavorLine("\"The forest is dangerous, but that was beyond what one might expect to find.\" Mendor seems shaken. \"I fear something is not right in the land. I shall continue to travel with you.\"")
                .WithInfo(129, 1, Artist.Ben_Zweifel);
            addCampaign("Journey Along the Anduin", EncounterSet.JourneyAlongTheAnduinCampaign, "Mirkwood Paths - Part 2")
                .WithTextLine("You are playing Campaign Mode.")
                .WithTextLine("Setup: Put Mendor into play. Set each copy of Valor and Scarred aside, out of play.")
                .WithTextLine("Response: After a Hill Troll is defeated, each player attaches 1 set-side copy of Valor to a hero they control, if able.")
                .WithTextLine("Forced: After a character is destroyed by a Hill Troll, each player attaches 1 set-aside copy of Scarred to a hero they control. (Limit once per game.)")
                .WithTextLine("If Mendor leaves play, the players lose the game")
                .WithOppositeTextLine("Resolution: Add each copy of Valor and Scarred in play to the Campaign Pool. Record the names of the heroes with Valor and/or Scarred attached in the notes section of the Campaign Log and attach them to those heroes when setting up each subsequent scenario in this campaign.")
                .WithOppositeTextLine("The hero with the most damage will be taken prisoner at the beginning of Escape from Dol Guldur (in case of a tie, randomly select among the heroes with the most damage.) Record the name of the \"prisoner\" in the notes section of the Campaign Log.")
                .WithOppositeFlavorLine("\"Our pursuers were too persistent and their ambush too well planned to be mere coincidence,\" says Mendor after finally reaching the shores of Lórien. \"I fear a greater evil directs them from the shadows.\"")
                .WithInfo(130, 1, Artist.Ben_Zweifel);
            addCampaign("Escape from Dol Guldur", EncounterSet.EscapeFromDolGuldurCampaign, "Mirkwood Paths - Part 3")
                .WithTextLine("You are playing Campaign Mode.")
                .WithTextLine("Setup: Put Mendor into play. Attached Appointed by Fate to a hero of the first player's choice.")
                ...
                .WithFlavorLine("Your guide, Mendor, has also been taken by the enemy!")
                .WithOppositeTextLine("Response: After the first objective is claimed, flip Mendor face-up and place 1 damage token on him.")
                .WithOppositeTextLine("Resolution: Determine one of the following:")
                .WithOppositeTextLine("1) If Mendor is still in play, add Mendor to the Campaign Pool.")
                .WithOppositeTextLine("If you do, put Mendor into play at the start of each scenario during your next campaign. Each player may include 1 copy of Mendor's Support in their deck during that campaign.")
                .WithOppositeFlavorLine("\"It has been an honor to share such a perilous adventure with you, friends,\" says Mendor. \"If you ever need my aid again, I would be glad to journey with you once more.\"")
                .WithOppositeTextLine("2) If Mendor is not in play, do not adjust the Campaign Pool for your next campaign.")
                .WithOppositeFlavorLine("Sadly, you bear Mendor's body back to Galadriel to prepare for his passing into the West.")
                .WithInfo(131, 1, Artist.Ben_Zweifel);
            addEvent("Mendor's Support", 0, Sphere.Neutral)
                .WithBoon()
                .WithTextLine("Only one copy of Mendor's Support can be played each round.")
                .WithTextLine("Action: Mendor gets +2 Willpower, +2 Attack, and +2 Defense until the end of the round.")
                .WithInfo(132, 4, Artist.Chris_Rahn);
            addAttachment("Valor", 0, Sphere.Neutral, false)
                .WithBoon()
                .WithTraits("Condition.")
                .WithKeywords("Permanent.")
                .WithTextLine("Permanent. Limit 1 per hero.")
                .WithTextLine("Response: After attached hero is declared as an attacker, exhaust Valor to heal 1 damage from attached hero and deal 1 damage to the defening enemy.")
                .WithInfo(133, 4, Artist.Chris_Rahn);
            addAttachment("Appointed by Fate", 0, Sphere.Neutral, false)
                .WithBoon()
                .WithTraits("Condition.")
                .WithTextLine("Attached hero collects 1 additional resource during each resource phase.")
                .WithFlavorLine("\"Yet it is not our part to master all the tides of the world, but to do what is in us for the succour of those years wherein we are set...\"")
                .WithFlavorLine("-Gandalf, The Return of the King")
                .WithInfo(134, 1, Artist.Anders_Finer);
            addObjectiveAlly("Mendor", string.Empty, 1, 1, 1, 3)
                .WithBoon()
                .WithUnique()
                .WithTraits("Silvan.", "Scout.")
                .WithKeywords("Ranged.")
                ...
                .WithTextLine("Response: After a quest card is defeated, ready Mendor. Then, each player draws 1 card.")
                .WithTextLine("If Mendor leaves play, remove him from the game.")
                .WithInfo(135, 1, Artist.Cris_Griffin);
            addEnemy("Ungoliant's Swarm", EncounterSet.PassageThroughMirkwoodCampaign, 33, 3, 2, 2, 5)
                .WithBurden()
                .WithTraits("Creature.", "Spider.")
                .WithTextLine("Forced: After Ungoliant's Swarm engages a player, that player must choose and exhaust 2 characters they control.")
                .WithShadow("Shadow: Put Ungoliant's Swarm into play engaged with you.")
                .WithInfo(136, 1, Artist.Andrew_Ryan);
            addTreachery("Lingering Venom", EncounterSet.PassageThroughMirkwoodCampaign)
                .WithBurden()
                .WithKeywords("Surge.")
                .WithTextLine("Surge.")
                .WithTextLine("When Revealed: Each player must choose: either exhaust each damaged character you control, or deal 2 damage to the hero you control with the most damage on it.")
                .WithShadow("Shadow: Exhaust each damaged character you control.")
                .WithInfo(137, 1, Artist.Magali_Villeneuve);
            addObjective("Scarred", EncounterSet.JourneyAlongTheAnduinCampaign)
                .WithBurden()
                .WithKeywords("Permanent.")
                .WithTextLine("Permanent. Limit 1 per hero.")
                .WithTextLine("Forced: After a character you control is destroyed, raise your threat by 1.")
                .WithInfo(138, 4, Artist.Magali_Villeneuve);
        }
    }
}