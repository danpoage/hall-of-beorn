    ...
    public class CoreSet : CardSet
    {
        protected override void Initialize()
        {
            ...
            addHero("Aragorn", 12, Sphere.Leadership, 2, 3, 2, 5)
                ...
                .WithText("Respuesta: Después de que Aragorn sea asignado a una misión, gasta 1 recurso de su reserva de Recursos para prepararlo.", Language.ES)
            ...
            Cards.Add(new LotRCard() {
                ...
                HtmlTemplate = "<p><b>Action:</b> Choose a player. Shuffle that player's discard pile back into his deck. Remove Will of the West from the game.</p><p class='flavor-text'>&quot;If Gondor has such men still in these days of fading, great must have been its glory in the days of its rising.&quot;<br>&ndash;Legolas, The Return of the King</p>",
                Quantity = 2,
                CardNumber = 49,
