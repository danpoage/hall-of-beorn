...
namespace HallOfBeorn.Models.LotR.Sets
{
    public class FlightOfTheStormcaller : CardSet
    {
        ...
        protected override void Initialize()
        {
            ...
            Cards.Add(LotRCard.Hero("Denethor", "", Sphere.Leadership, 8, 1, 1, 3, 3)
            ...
            Cards.Add(LotRCard.Event("Tides of Fate", "", Sphere.Spirit, 0)
            ...
            Cards.Add(LotRCard.Event("Vanish from Sight", "", Sphere.Neutral, 0)
            ...
            Cards.Add(LotRCard.Quest("Swift Departure", "", 4, 1, setName, 8)
            ...
            Cards.Add(LotRCard.Quest("Full Sail Ahead", "", 4, 2, setName, 12)
                .WithSuffix("AB")
            ...
            Cards.Add(LotRCard.Quest("The Weather Turns Foul", "", 4, 3, setName, 18)
                .WithSuffix("AB")
            ...
            Cards.Add(LotRCard.Quest("The Cape of Andrast", "", 4, 4, setName, 24)
                .WithSuffix("AB")
            ...
            Cards.Add(LotRCard.Quest("Full Sail Ahead", "", 4, 2, setName, 12, 'C')
                .WithSuffix("CD")
            ...
            Cards.Add(LotRCard.Quest("The Weather Turns Foul", "", 4, 3, setName, 18, 'C')
                .WithSuffix("CD")
            ...
            Cards.Add(LotRCard.Quest("The Cape of Andrast", "", 4, 4, setName, 24, 'C')
                .WithSuffix("CD")
            ...
            Cards.Add(LotRCard.ShipEnemy("Stormcaller", setName, 50, 2, 6, 6, 18)
                .WithUnique()
            ...
            Cards.Add(LotRCard.ShipEnemy("Corsair Skiff", setName, 24, 1, 2, 2, 5)
                .WithTraits("Corsair.", "Ship.")
                .WithKeywords("Surge.")
            ...
            Cards.Add(LotRCard.Enemy("Corsair Seafarer", "", setName, 26, 2, 2, 2, 3)
            ...
            Cards.Add(LotRCard.Enemy("Serpent's Blade", "", setName, 10, 3, 3, 3, 4)
                .WithTraits("Corsair.")
            ...
            Cards.Add(LotRCard.Location("Jagged Reef", "", setName, 1, 4)
            ...
            Cards.Add(LotRCard.Location("Hidden Cove", "", setName, 3, 3)
                .WithTraits("Coastland.", "Ocean.")
            ...
            Cards.Add(LotRCard.Location("Vast Coastland", "", setName, 6, 4)
                .WithTraits("Coastland.", "Ocean.")
            ...
            Cards.Add(LotRCard.Treachery("Man Overboard!", "", setName)
            ...
            Cards.Add(LotRCard.Treachery("Raging Squall", "", setName)
