...
namespace HallOfBeorn.Models.LotR.Sets
{
    public class TheFlameOfTheWest : CardSet
    {
        ...
        protected override void Initialize()
        {
            ...
            Cards.Add(LotRCard.Quest("The Forbidden Door", string.Empty, 13, 1, setThePassingOfTheGreyCompany, null)
            ...
            Cards.Add(LotRCard.Quest("The Paths of the Dead", string.Empty, 13, 2, setThePassingOfTheGreyCompany, 254)
            ...
            Cards.Add(LotRCard.Quest("The Dead are Following", string.Empty, 13, 3, setThePassingOfTheGreyCompany, 5)
            ...
            Cards.Add(LotRCard.Campaign("The Passing of the Grey Company", string.Empty, 13, setThePassingOfTheGreyCompany, "The Lord of the Rings - Part 13")
            ...
            Cards.Add(LotRCard.Quest("Attack on Pelargir", string.Empty, 14, 1, setTheSiegeOfGondor, 20)
            ...
            Cards.Add(LotRCard.Campaign("The Siege of Gondor", string.Empty, 14, setTheSiegeOfGondor, "The Lord of the Rings - Part 14")
            ...
            Cards.Add(LotRCard.Quest("The Garrison of Gondor", string.Empty, 15, 1, setTheBattleOfThePelennorFields, 2)
            ...
            Cards.Add(LotRCard.Quest("Retreat from Osgiliath", string.Empty, 15, 2, setTheBattleOfThePelennorFields, 254)
            ...
            Cards.Add(LotRCard.Quest("The White City Besieged", string.Empty, 15, 3, setTheBattleOfThePelennorFields, 4)
            ...
            Cards.Add(LotRCard.Quest("Rohan has Come!", string.Empty, 15, 4, setTheBattleOfThePelennorFields, null)
            ...
            Cards.Add(LotRCard.Quest("Fighting in the Fields", string.Empty, 15, 5, setTheBattleOfThePelennorFields, 20)
            ...
            Cards.Add(LotRCard.Campaign("The Battle of the Pelennor Fields", string.Empty, 15, setTheBattleOfThePelennorFields, "The Lord of the Rings - Part 15")
