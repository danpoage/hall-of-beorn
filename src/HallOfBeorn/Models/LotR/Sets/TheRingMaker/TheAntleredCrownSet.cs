    ...
    public class TheAntleredCrownSet : CardSet
    {
        protected override void Initialize()
        {
            ...
            addLocation("Raven Chief's Camp", EncounterSet.TheAntleredCrown, 4, 9)
                ...
                .WithTextLine("Forced: After the last time counter is removed from this location, exhaust each damaged character. Place 3 time counters on this location.")
                .WithVictoryPoints(3)
            ...
            addLocation("Raven War-camp", EncounterSet.TheAntleredCrown, 2, 4)
                .WithTraits("Dunland.")
                .WithKeywords("Time 3.")
                .WithTextLine("Forced: After the last time counter is removed from this location, starting with the first player, each player draws the top card of the ~Raven deck and puts it into play engaged with him.")
            ...
            addLocation("Raven Village", EncounterSet.TheAntleredCrown, 2, 3)
                .WithTraits("Dunland.")
                .WithKeywords("Time 2.")
                .WithTextLine("Forced: After the last time counter is removed from this location, reveal the top card of the ~Raven deck and add it to the staging area.")
            ...
            addLocation("Dunland Battlefield", EncounterSet.TheAntleredCrown, 3, 5)
                .WithTraits("Dunland.")
                .WithKeywords("Time 3.")
                .WithTextLine("Forced: After the last time counter is removed from this location, each player assigns X damage among characters he controls, where X is the number of cards in his hand.")
            ...
            addLocation("Raven Country", EncounterSet.TheAntleredCrown, 3, 6)
                .WithTraits("Dunland.")
                .WithKeywords("Time 4.")
                .WithTextLine("Forced: After the last time counter is removed from this location, each player raises his threat by the number of cards in his hand.")
