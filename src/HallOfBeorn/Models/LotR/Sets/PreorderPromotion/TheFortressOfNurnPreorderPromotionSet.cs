...
namespace HallOfBeorn.Models.LotR.Sets.PreorderPromotion
{
    ...
    {
        private const string setName = "The Fortress of Nurn Preorder Promotion";

        public static CardSet Create() {
            
            var cs = CardSet.Create(setName, "TFoN-PRM", Models.SetType.Preorder_Promotion, "Vengeance of Mordor", 6);

            cs.addHero("Aragorn", 12, Sphere.Spirit, 2, 3, 2, 5)
            ...
            cs.addAlly("Misty Mountain Journeyman", 1, Sphere.Spirit, false, 2, 0, 0, 1)
            ...
            cs.addAttachment("Thorongil", 3, Sphere.Neutral, true)
                .WithTraits("Title.")
