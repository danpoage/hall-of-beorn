...
namespace HallOfBeorn.Models.LotR.Sets.PreorderPromotion
{
        ...
        : CardSet
    {
        ...
        public static CardSet Create() {
            ...
            var cs = CardSet.Create(setName, "TCoU-PRM", Models.SetType.Preorder_Promotion, "Vengeance of Mordor", 2);

            cs.addHero("Lothíriel", 8, Sphere.Spirit, 3, 1, 1, 3)
            ...
            cs.addAlly("Angbor the Fearless", 2, Sphere.Leadership, true, 2, 1, 0, 2)
            ...
            cs.addEvent("Host of Galadhrim", 4, Sphere.Neutral)
