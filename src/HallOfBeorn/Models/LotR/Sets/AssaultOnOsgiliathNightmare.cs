...
Finally, flip this setup card over and place it next to the quest deck. Its effects remain active throughout the game, which is now ready to begin.",
            ...
            Cards.Add(LotRCard.Location("Crumbled Battlements", "EBB34447-9755-472D-B9BB-29C47B90ACE0", "Assault on Osgiliath Nightmare", 3, 2)
                .WithTraits("Osgiliath.")
                .WithText("Forced: When you take control of Crumbled Battlements, shuffle the encounter discard pile into the encounter deck and discard cards from the encounter deck until an enemy is discarded. Put the discarded enemy into play engaged with you.")
                .WithFlavor("\"Here they come pouring through the breaches!\" -Man of Gondor, The Return of the King")
            ...
            Cards.Add(LotRCard.Treachery("Pressed on All Sides", "30A55F5C-5921-4F6A-A6E7-78DF6217321D", "Assault on Osgiliath Nightmare")
                .WithText("When Revealed: If the total Threat of locations controlled by players is greater than the total Threat in the staging area, raise each player's threat by 2 and immediately end the quest phase without resolving the quest.")
