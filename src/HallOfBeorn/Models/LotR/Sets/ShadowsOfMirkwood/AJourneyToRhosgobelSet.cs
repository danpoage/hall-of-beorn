...
namespace HallOfBeorn.Models.LotR.Sets.ShadowsOfMirkwood
{
    ...
    {
        public const string setName = "A Journey to Rhosgobel";
        ...
        protected override void Initialize()
        {
            ...
            addQuest("The Wounded Eagle", EncounterSet.AJourneyToRhosgobel.Name, 1, 'A', 8)
            ...
            addQuest("Radagast's Request", EncounterSet.AJourneyToRhosgobel.Name, 2, 'A', 12)
                .WithIncludedEncounterSets(EncounterSet.DolGuldurOrcs, EncounterSet.SpidersOfMirkwood)
            ...
            addQuest("Return to Rhosgobel", EncounterSet.AJourneyToRhosgobel.Name, 3, 'A', 0)
                .WithIncludedEncounterSets(EncounterSet.DolGuldurOrcs, EncounterSet.SpidersOfMirkwood)
            ...
            addObjective("Athelas", EncounterSet.AJourneyToRhosgobel.Name)
                .WithTraits("Item.")
            ...
            addObjectiveAlly("Wilyador", EncounterSet.AJourneyToRhosgobel.Name, 1, 1, 1, 20)
                .WithUnique()
                .WithTraits("Creature.", "Eagle.")
            ...
            addTreachery("Swarming Insects", EncounterSet.AJourneyToRhosgobel.Name)
            ...
            addTreachery("Festering Wounds", EncounterSet.AJourneyToRhosgobel.Name)
            ...
            addEnemy("Mirkwood Flock", EncounterSet.AJourneyToRhosgobel.Name, 32, 1, 2, 1, 3)
                .WithTraits("Creature.")
