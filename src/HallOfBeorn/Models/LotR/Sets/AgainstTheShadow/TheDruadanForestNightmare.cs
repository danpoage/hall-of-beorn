...
Finally, flip this setup card over and place it next to the quest deck. Its effects remain active throughout the game, which is now ready to begin.",
            ...
            Cards.Add(new LotRCard()
            {
                ...
                Text = "Prowl 2.\r\nEach hero with no resources in its resource pool cannot be declared as an attacker or defender against Drúadan Warrior.",
                EncounterSet = "The Drúadan Forest Nightmare",
                Quantity = 3,
                CardNumber = 3,
            ...
            Cards.Add(new LotRCard()
            {
                ...
                Text = "Archery 3.\r\nAs an additional cost to optionally engage Drúadan Stalker, you must spend 2 resources.",
                EncounterSet = "The Drúadan Forest Nightmare",
                Quantity = 3,
                CardNumber = 4,
                Artist = Artist.Jason_Ward
