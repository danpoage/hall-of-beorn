...
namespace HallOfBeorn.Models.LotR.Sets
{
    public class TheWastesOfEriador : CardSet
    {
        protected override void Initialize()
        {
            ...
            Cards.Add(LotRCard.Quest("Across the Wastes", "", 1, 1, "The Wastes of Eriador", 20)
            ...
            Cards.Add(LotRCard.Quest("Howling at Night", "", 1, 2, "The Wastes of Eriador", 15)
            ...
            Cards.Add(LotRCard.Quest("Battle with the Pack", "", 1, 3, "The Wastes of Eriador", 5)
