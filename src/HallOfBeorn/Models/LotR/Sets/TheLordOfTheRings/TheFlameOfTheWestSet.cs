    ...
    public class TheFlameOfTheWestSet : CardSet
    {
        ...
        protected override void Initialize()
        {
            ...
            addHero("Aragorn", 0, Sphere.Fellowship, 2, 3, 2, 5)
                ...
                .WithTextLine("While Aragorn has an Artifact attached, he gains sentinel and does not exhaust to quest.")
                .WithFlavorLine("\"I have no help to send, therefore I must go myself...\"")
            ...
            addHero("Éowyn", 9, Sphere.Tactics, 4, 1, 1, 3)
                ...
                .WithCommunityVersion("Hrodebert/Eowyn-Tactics-Hero")
            ...
            addAttachment("Esquire of Rohan", 0, Sphere.Neutral, true)
                .WithBoon()
                .WithTraits("Title.")
                .WithKeywords("Permanent.")
                .WithTextLine("Permanent.")
                .WithTextLine("Setup: Attach to a hero.")
                .WithTextLine("Attached hero gains the Rohan trait.")
                .WithTextLine("Attached hero gets +1 Attack while attacking with another Rohan character.")
                .WithFlavorLine("\"Rise now, Meriadoc, esquire of Rohan of the household of Meduseld!\"")
                .WithFlavorLine("-Théoden, The Return of the King")
                .WithInfo(14, 1, Artist.Romana_Kendelic);
            addAttachment("Esquire of Gondor", 0, Sphere.Neutral, true)
                .WithBoon()
                .WithTraits("Title.")
                .WithKeywords("Permanent.")
                .WithTextLine("Permanent.")
                .WithTextLine("Setup: Attach to a hero.")
                .WithTextLine("Attached hero gains the Gondor trait.")
                .WithTextLine("Attached hero gets +1 Willpower while commited to the quest with another Gondor character.")
                .WithFlavorLine("\"Here do I swear fealty and service to Gondor, and to the Lord and Steward of the realm...\"")
                .WithFlavorLine("-Pippin, The Return of the King")
                .WithInfo(15, 1, Artist.Romana_Kendelic);
            addObjective("Overcome by Fear", setThePassingOfTheGreyCompany)
                .WithBurden()
                .WithTraits("Fear.")
                .WithTextLine("Setup: Attach to your threat dial. Limit 1 per threat dial.")
                .WithTextLine("Your threat cannot be reduced.")
                .WithTextLine("Forced: At the end of the round, raise your threat by 1. Then you may spend 1 Fellowship resource to detach Overcome by ~Fear and set it aside, out of play.")
