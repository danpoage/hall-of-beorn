    ...
    public class TheUrukHaiNightmare : CardSet
    {
        ...
        protected override void Initialize()
        {
            ...
            addCard(LotRCard.NightmareSetup(setName, setName)
                ...
                .WithFlavor("\"You'll run with me behind you,\" said Uglúk. \"Run! Or you'll never see your beloved holes again.\"\r\n-The Two Towers")
                .WithOppositeText("Begin with the standard quest deck and encounter deck for The Uruk-hai scenario.\r\nRemove the following cards, in the specified quantities, from the standard encounter deck:\r\n3x Uruk-hai Figter\r\n1x Snaga\r\n2x Eastemnet\r\n2x Plains of Rohan\r\n3x The Wold\r\n2x Unseen Barrier\r\nThen, shuffle the encounter cards in this Nightmare ~Deck into the remainder of the standard The Uruk-hai encounter deck.\r\nFinally, flip this setup card over and place it next to the quest deck. Its effect remains active throughout the game, which is now ready to begin.")
