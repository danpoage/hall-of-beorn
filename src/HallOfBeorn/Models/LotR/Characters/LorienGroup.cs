...
<li>Dwimordene. The name means 'haunted valley' in Old English.</li>
            ...
            Card("Lorien-Guide-Core");
            Card("Galadriel's-Handmaiden-CS");
            Card("Galadhrim-Minstrel-TiT");
            Card("Galadhrim-Weaver-TToR");
            Card("Galadhon-Archer-NiE");
            Card("Marksman-of-Lorien-TDRu");
            Card("O-Lorien-TiT");
            Card("Protector-of-Lorien-Core");
            Card("Bow-of-the-Galadhrim-NiE");
            Card("Cloak-of-Lorien-CS");
            Card("Lorien-Rope-RD");
            Card("The-Galadhrim's-Greeting-Core");
            Card("Lorien's-Wealth-Core");
            Card("Lost-Soul-of-Lorien-TDMN");
        }
    }
}