    ...
    public class TextTemplate
    {
        ...
        private static string GetDiscordTemplate(string template)
        {
            var map = new Dictionary<string, string>
            {
                ...
                { "<p class='flavor-text-smaller'>", "{stop}" },
                { "<p style='text-align:center'>", "{stop}" },
                { "<p style='text-align:center;'>", "{stop}" },
                { "<p style='float:left'>", string.Empty },
                { "<p style='float:right'>", string.Empty },
                { "</p>", "\n" },
                { "<p>", string.Empty },
                { "<ul class='no-style-list'>", string.Empty },
                { "<ul>", string.Empty },
                { "</ul>", "\n" },
                { "<li>", string.Empty },
                { "</li>", "\n" },
        ...
        private void insertHtmlToken(StringBuilder sb, string type, string key, string label, Language lang)
        {
            ...
            switch (type.ToLowerSafe())
            {
                ...
                case "victory":
                    ...
                    break;
                case "xp":
                    sb.AppendFormat("<div class='victory-text'><a style='text-decoration:none;' href='/LotR/Search?XP={0}' target='_blank' title='XP: {0}'><span style='padding-left:4px;padding-right:4px;'>{0} XP</span></a></div>", key);
                    break;
                case "cave":
