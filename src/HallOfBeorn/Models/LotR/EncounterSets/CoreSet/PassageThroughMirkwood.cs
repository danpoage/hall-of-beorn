...
namespace HallOfBeorn.Models.LotR.EncounterSets.CoreSet
{
    public class PassageThroughMirkwood : CoreSetEncounterSet
    {
        public PassageThroughMirkwood()
            : base("Passage Through Mirkwood")
        {
            Enemy("Forest Spider", 25, 2, 2, 1, 4)
            ...
            Enemy("East Bight Patrol", 5, 3, 3, 1, 2)
            ...
            Enemy("Black Forest Bats", 15, 1, 1, 0, 2)
                .WithTraits("Creature.")
            ...
            Quest("A Fork in the Road", 2, 'A', 2)
