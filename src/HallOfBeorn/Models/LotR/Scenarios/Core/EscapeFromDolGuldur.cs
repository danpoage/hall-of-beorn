namespace HallOfBeorn.Models.LotR.Scenarios.Core
{
    public class EscapeFromDolGuldur : Scenario
    {
        public EscapeFromDolGuldur()
        {
            ...
            AddPlayLink(LinkType.The_Progression_Series, "https://www.youtube.com/watch?v=Q6eM2DnPtHo&index=28&list=PLmkDVibqfjU65cexxMcQDhPC52XKgWWVp&t=0s", "3: Escape from Dol Guldur", "https://i.ytimg.com/vi/Q6eM2DnPtHo/hqdefault.jpg");
