...
Finally, flip this setup card over and place it next to the quest deck. Its effects remain active throughout the game, which is now ready to begin.",
            ...
            Cards.Add(Card.Enemy("Methedras Lookout", "", setName, 44, 3, 5, 4, 5)
                .WithTraits("Orc.")
            ...
            Cards.Add(Card.Enemy("Guard Wolf", "", setName, 25, 4, 3, 3, 3)
                .WithTraits("Creature.")
            ...
            Cards.Add(Card.Location("Methedras Peak", "", setName, 254, 5)
                .WithTraits("Mountain.")
            ...
            Cards.Add(Card.Location("Orc Trail", "", setName, 4, 2)
                .WithTraits("Mountain.")
            ...
            Cards.Add(Card.Treachery("Mugash's Cunning", "", setName)
            ...
            Cards.Add(Card.Treachery("Patrolling Orcs", "", setName)
            ...
            Cards.Add(Card.Treachery("Mugash's Rage", "", setName)
