...
Finally, flip this setup card over and place it next to the quest deck. Its effects remain active throughout the game, which is now ready to begin.",
            ...
            Cards.Add(Card.Location("Ford of Bruinen", "D612D16F-17BB-4E53-B8DF-DEB872A78558", "Flight to the Ford Nightmare", 3, 3)
                .WithUnique()
                .WithTraits("River.")
            ...
            Cards.Add(Card.Location("Trollshaw Forest", "EAC231F5-7DAC-4BCA-AB5A-FB8EF9665AAE", "Flight to the Ford Nightmare", 3, 5)
                .WithTraits("Forest.")
            ...
            Cards.Add(Card.Location("Great East Road", "73B1FDBB-BEF6-4859-AB4E-729F83D3711B", "Flight to the Ford Nightmare", 254, 5)
                .WithTraits("Road.")
            ...
            Cards.Add(Card.Location("Pathless Wilderness", "32398738-3E58-4407-B4C2-A13316333740", "Flight to the Ford Nightmare", 2, 6)
            ...
            Cards.Add(Card.Location("Ettendales", "F26AFBA2-CCBF-4722-AE28-FB14B6320704", "Flight to the Ford Nightmare", 5, 3)
                .WithTraits("Forest.", "Hills.")
            ...
            Cards.Add(Card.Treachery("Come Back!", "4C2EF7A7-EDFC-40C0-9B40-8DAD975CE7DB", "Flight to the Ford Nightmare")
            ...
            Cards.Add(Card.Treachery("The Twilight World", "AC9D02D0-D014-41AA-86EA-D11675E3346A", "Flight to the Ford Nightmare")
                .WithTraits("Morgul.")
