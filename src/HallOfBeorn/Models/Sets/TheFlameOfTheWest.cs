...
namespace HallOfBeorn.Models.Sets
{
    public class TheFlameOfTheWest : CardSet
    {
        ...
        protected override void Initialize()
        {
            ...
            Cards.Add(Card.Objective("Minas Tirith", string.Empty, setTheBattleOfThePelennorFields)
                .WithUnique()
            ...
            Cards.Add(Card.Location("Grond", string.Empty, setTheBattleOfThePelennorFields, 254, 3)
                .WithUnique()
                .WithTraits("Siege.")
            ...
            Cards.Add(Card.Location("Gate of Gondor", string.Empty, setTheBattleOfThePelennorFields, 5, 3)
                .WithUnique()
            ...
            Cards.Add(Card.Location("City Wall", string.Empty, setTheBattleOfThePelennorFields, 3, 4)
                .WithTraits("Minas Tirith.")
            ...
            Cards.Add(Card.Location("Pelennor Field", string.Empty, setTheBattleOfThePelennorFields, 2, 4)
                .WithTraits("Pelennor.")
            ...
            Cards.Add(Card.Location("Fire-filled Trench", string.Empty, setTheBattleOfThePelennorFields, 2, 3)
            ...
            Cards.Add(Card.Location("Siege Tower", string.Empty, setTheBattleOfThePelennorFields, 3, 3)
                .WithTraits("Siege.")
            ...
            Cards.Add(Card.Enemy("The Black Serpent", string.Empty, setTheBattleOfThePelennorFields, 38, 4, 5, 2, 5)
                .WithUnique()
                .WithTraits("Harad.")
            ...
            Cards.Add(Card.Enemy("War Mûmak", string.Empty, setTheBattleOfThePelennorFields, 46, 4, 6, 2, 9)
            ...
            Cards.Add(Card.Enemy("Southron Champion", string.Empty, setTheBattleOfThePelennorFields, 34, 2, 4, 2, 4)
                .WithTraits("Harad.")
            ...
            Cards.Add(Card.Enemy("Morgul Captain", string.Empty, setTheBattleOfThePelennorFields, 35, 3, 3, 1, 4)
            ...
            Cards.Add(Card.Enemy("Orc of the Eye", string.Empty, setTheBattleOfThePelennorFields, 40, 2, 3, 1, 3)
                .WithTraits("Orc.", "Mordor.")
            ...
            Cards.Add(Card.Enemy("Mordor Orc", string.Empty, setTheBattleOfThePelennorFields, 30, 1, 2, 1, 2)
                .WithTraits("Orc.", "Mordor.")
                .WithKeywords("Surge.")
            ...
            Cards.Add(Card.Treachery("The Rammas is Breached", string.Empty, setTheBattleOfThePelennorFields)
            ...
            Cards.Add(Card.Treachery("Fell Beast", string.Empty, setTheBattleOfThePelennorFields)
                .WithTraits("Morgul.")
                .WithKeywords("Surge.")
            ...
            Cards.Add(Card.Treachery("Black Dart", string.Empty, setTheBattleOfThePelennorFields)
                .WithTraits("Morgul.")
            ...
            Cards.Add(Card.Treachery("Spells of Ruin", string.Empty, setTheBattleOfThePelennorFields)
                .WithTraits("Sorcery.")
            ...
            Cards.Add(Card.Treachery("Dread and Despair", string.Empty, setTheBattleOfThePelennorFields)
                .WithTraits("Sorcery.")
            ...
            Cards.Add(Card.Treachery("Shadow of Mordor", string.Empty, setTheBattleOfThePelennorFields)
                .WithTraits("Sorcery.")
                .WithKeywords("Doomed 1.")
            ...
            Cards.Add(Card.Enemy("Wraith on Wings", string.Empty, setTheBattleOfThePelennorFields, 45, 0, 6, 4, 12)
                .WithBurden()
                .WithTraits("Nazgûl.")
            ...
            Cards.Add(Card.Quest("The Garrison of Gondor", string.Empty, 15, 1, setTheBattleOfThePelennorFields, 2)
            ...
            Cards.Add(Card.Quest("Retreat from Osgiliath", string.Empty, 15, 2, setTheBattleOfThePelennorFields, 254)
            ...
            Cards.Add(Card.Quest("The White City Besieged", string.Empty, 15, 3, setTheBattleOfThePelennorFields, 4)
            ...
            Cards.Add(Card.Quest("Rohan has Come!", string.Empty, 15, 4, setTheBattleOfThePelennorFields, null)
            ...
            Cards.Add(Card.Quest("Fighting in the Fields", string.Empty, 15, 5, setTheBattleOfThePelennorFields, 20)
            ...
            Cards.Add(Card.Campaign("The Battle of the Pelennor Fields", string.Empty, 15, setTheBattleOfThePelennorFields, "The Lord of the Rings - Part 15")
            ...
            Cards.Add(Card.Enemy("The Witch-king", string.Empty, setTheBattleOfThePelennorFields, 50, 6, 6, 6, 14)
                .WithSuffix("Captain")
                .WithUnique()
