...
namespace HallOfBeorn.Models.Sets
{
    public class TheSandsOfHarad : CardSet
    {
        protected override void Initialize()
        {
            ...
            Cards.Add(Card.Hero("Gimli", string.Empty, Sphere.Leadership, 11, 2, 2, 2, 5)
            ...
            Cards.Add(Card.Hero("Legolas", string.Empty, Sphere.Spirit, 9, 1, 3, 1, 4)
            ...
            Cards.Add(Card.Ally("Vigilant Dúnadan", string.Empty, Sphere.Tactics, 4, 1, 3, 2, 3)
            ...
            Cards.Add(Card.Event("Unlikely Friendship", string.Empty, Sphere.Leadership, 0)
            ...
            Cards.Add(Card.Attachment("Dwarven Shield", string.Empty, Sphere.Leadership, 2)
                .WithGeneric()
            ...
            Cards.Add(Card.Attachment("Mirkwood Long-knife", string.Empty, Sphere.Spirit, 2)
                .WithGeneric()
            ...
            Cards.Add(Card.PlayerSideQuest("The Storm Comes", string.Empty, Sphere.Neutral, 0, 5)
