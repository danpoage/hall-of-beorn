...
namespace HallOfBeorn.Models.Sets
{
    public class TheSiegeOfAnnuminas : CardSet
    {
        ...
        protected override void Initialize()
        {
            ...
            Cards.Add(Card.Quest("Guard the Gate", string.Empty, 7, 2, setName, 50)
                .WithStageLetter('C')
            ...
            Cards.Add(Card.Quest("Rescue the Captives", string.Empty, 7, 3, setName, null)
                .WithStageLetter('C')
            ...
            Cards.Add(Card.Quest("Delay the Enemy", string.Empty, 7, 1, setName, null)
                .WithStageLetter('E')
            ...
            Cards.Add(Card.Quest("Man the Walls", string.Empty, 7, 2, setName, 50)
                .WithStageLetter('E')
            ...
            Cards.Add(Card.Quest("Stop the Attack", string.Empty, 7, 3, setName, null)
                .WithStageLetter('E')
            ...
            Cards.Add(Card.Objective("Annúminas", string.Empty, setName)
                .WithUnique()
                .WithTraits("City.")
            ...
            Cards.Add(Card.Enemy("Lieutenant of Angmar", string.Empty, setName, 0, 4, 6, 4, 9)
                .WithUnique()
            ...
            Cards.Add(Card.Location("Battering Ram", string.Empty, setName, 254, 5)
                .WithUnique()
                .WithTraits("Siege.")
            ...
            Cards.Add(Card.Location("Enemy Camp", string.Empty, setName, 5, 5)
                .WithUnique()
                .WithTraits("Siege.")
            ...
            Cards.Add(Card.Location("Siege Tunnel", string.Empty, setName, 5, 5)
                .WithUnique()
                .WithTraits("Siege.")
            ...
            Cards.Add(Card.Enemy("Host of Angmar", string.Empty, setName, 50, 4, 9, 4, 12)
                .WithTraits("Orc.")
            ...
            Cards.Add(Card.ObjectiveAlly("Dúnedain of Annúminas", string.Empty, setName, 1, 2, 2, 3)
                .WithTraits("Dúnedain.")
            ...
            Cards.Add(Card.Location("Gate of Annúminas", string.Empty, setName, 254, 5)
