...
namespace HallOfBeorn.Models.Sets
{
    public class TheWastesOfEriador : CardSet
    {
        protected override void Initialize()
        {
            ...
            Cards.Add(Card.Objective("Nightfall", "", "The Wastes of Eriador")
                .WithTraits("Time.")
            ...
            Cards.Add(Card.Enemy("Pack Leader", "", "The Wastes of Eriador", 1, 4, 5, 4, 8)
                .WithUnique()
            ...
            Cards.Add(Card.Enemy("Blood-thirsty Warg", "", "The Wastes of Eriador", 35, 2, 4, 2, 5)
                .WithTraits("Creature.", "Warg.")
            ...
            Cards.Add(Card.Enemy("Hunting Pack", "", "The Wastes of Eriador", 40, 3, 6, 3, 6)
                .WithTraits("Creature.", "Warg.")
            ...
            Cards.Add(Card.Enemy("White Warg", "", "The Wastes of Eriador", 20, 2, 2, 3, 3)
                .WithTraits("Creature.", "Warg.")
            ...
            Cards.Add(Card.Enemy("Wolf of Angmar", "", "The Wastes of Eriador", 25, 1, 2, 1, 3)
                .WithTraits("Creature.", "Warg.")
                .WithKeywords("Surge.")
            ...
            Cards.Add(Card.Location("Eriador Wastes", "", "The Wastes of Eriador", 3, 5)
            ...
            Cards.Add(Card.Location("Warg's Den", "", "The Wastes of Eriador", 4, 1)
                .WithTraits("Arnor.")
            ...
            Cards.Add(Card.Location("North Downs", "", "The Wastes of Eriador", 1, 4)
            ...
            Cards.Add(Card.Treachery("Sudden Darkness", "", "The Wastes of Eriador")
                .WithTraits("Weather.")
            ...
            Cards.Add(Card.Treachery("Predatory Wolves", "", "The Wastes of Eriador")
