...
namespace HallOfBeorn.Models.Sets
{
    public class TheBattleOfCarnDum : CardSet
    {
        ...
        protected override void Initialize()
        {
            ...
            Cards.Add(Card.Location("Accursed Battlefield", "", setName, 2, 3)
                .WithTraits("Carn Dûm.")
            ...
            Cards.Add(Card.Location("Mountains of Angmar", "", setName, 3, 5)
                .WithTraits("Mountain.")
            ...
            Cards.Add(Card.Location("Blight of Carn Dûm", "", setName, 3, 3)
            ...
            Cards.Add(Card.Location("Fortress Walls", "", setName, 4, 3)
                .WithTraits("Carn Dûm.")
            ...
            Cards.Add(Card.Treachery("The Sky Darkens", "", setName)
                .WithTraits("Sorcery.")
            ...
            Cards.Add(Card.Treachery("Vile Afflication", "", setName)
                .WithTraits("Sorcery.")
            ...
            Cards.Add(Card.Treachery("Daechanar's Will", "", setName)
            ...
            Cards.Add(Card.EncounterSideQuest("Furious Charge", "", setName, 5)
                .WithKeywords("Surge.")
