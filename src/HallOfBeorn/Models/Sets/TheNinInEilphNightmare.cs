...
Finally, flip this setup card over and place it next to the quest deck. Its effects remain active throughout the game, which is now ready to begin.")
            ...
            Cards.Add(Card.Enemy("Deadly Marsh Adder", "", setName, 30, 3, 4, 2, 5)
                .WithTraits("Creature.")
            ...
            Cards.Add(Card.Enemy("Swarm of Mosquitoes", "", setName, 25, 2, 3, 1, 7)
            ...
            Cards.Add(Card.Location("Desolate Meadow", "", setName, 2, 5)
                .WithTraits("Marsh.")
            ...
            Cards.Add(Card.Location("Peat Bog", "", setName, 3, 3)
                .WithTraits("Marsh.")
            ...
            Cards.Add(Card.Treachery("Quicksand", "", setName)
            ...
            Cards.Add(Card.Treachery("Rotten Stench", "", setName)
            ...
            Cards.Add(Card.Quest("Through the Marsh", "", 0, 2, setName, 13)
            ...
            Cards.Add(Card.Quest("Lost in the Swanfleet", "", 0, 3, setName, 16)
