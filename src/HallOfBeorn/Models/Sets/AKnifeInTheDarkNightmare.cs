...
Finally, flip this setup card over and place it next to the quest deck. Its effects remain active throughout the game, which is now ready to begin.",
            ...
            Cards.Add(Card.Enemy("Southern Spy", "E57784A3-EF74-4EAC-8830-B712D5DC9661", "A Knife in the Dark Nightmare", 25, 3, 4, 2, 4)
                .WithTraits("Spy.")
            ...
            Cards.Add(Card.Location("Weathertop", "B6B4518F-1A04-475F-91F3-AE4C44F6F151", "A Knife in the Dark Nightmare", 4, 6)
                .WithUnique()
            ...
            Cards.Add(Card.Location("Forsaken Inn", "9F04DEA7-A655-4941-8DFC-16AFF7B9748B", "A Knife in the Dark Nightmare", 254, 4)
                .WithTraits("Inn.")
            ...
            Cards.Add(Card.Treachery("The Ring's Will", "880F02B4-7C63-4078-B311-6DE55F764DC8", "A Knife in the Dark Nightmare")
            ...
            Cards.Add(Card.Treachery("Blade Tip", "993E2EB0-22F8-41BB-9E65-5498AFF37065", "A Knife in the Dark Nightmare")
                .WithTraits("Morgul.")
