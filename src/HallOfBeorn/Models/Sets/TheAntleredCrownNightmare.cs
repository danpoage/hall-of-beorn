...
Finally, flip this setup card over and place it next to the quest deck. Its effects remain active throughout the game, which is now ready to begin.\r\nNote: Dunlending Horde has the 'Dunlending Warriors' encounter set icon and should be shuffled into the Raven deck during setup.")
            ...
            Cards.Add(Card.Enemy("Dunlending Horde", "", setName, 32, 4, 6, 3, 8)
                .WithTraits("Dunland.")
            ...
            Cards.Add(Card.Enemy("Raven Clan Elite", "", setName, 28, 2, 4, 2, 4)
            ...
            Cards.Add(Card.Enemy("Raven Clan Druid", "", setName, 26, 3, 2, 3, 5)
                .WithTraits("Dunland.", "Raven Clan.")
            ...
            Cards.Add(Card.Location("Raven Stronghold", "", setName, 2, 5)
                .WithTraits("Dunland.")
                .WithKeywords("Time 3.")
            ...
            Cards.Add(Card.Location("Highlands of Dunland", "", setName, 4, 4)
                .WithTraits("Dunland.")
                .WithKeywords("Time 2.")
            ...
            Cards.Add(Card.Treachery("Raven Talisman", "", setName)
            ...
            Cards.Add(Card.Treachery("Gathering Forces", "", setName)
