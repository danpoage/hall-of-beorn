...
namespace HallOfBeorn.Models.Sets
{
    public class TheDrownedRuins : CardSet
    {
        ...
        protected override void Initialize()
        {
            ...
            Cards.Add(Card.Quest("The Grotto", string.Empty, 4, 1, setName, 15)
            ...
            Cards.Add(Card.Quest("Sahír's Betrayal", string.Empty, 4, 2, setName, null)
            ...
            Cards.Add(Card.Location("Shrine to Morgoth", string.Empty, setName, 5, 18)
                .WithUnique()
                .WithSuffix("Grotto")
            ...
            Cards.Add(Card.Enemy("Sea-scorpion", string.Empty, setName, 30, 2, 2, 2, 4)
                .WithGeneric()
                .WithTraits("Creature.")
            ...
            Cards.Add(Card.Enemy("Cave Eel", string.Empty, setName, 20, 3, 3, 4, 2)
                .WithGeneric()
                .WithTraits("Creature.")
            ...
            Cards.Add(Card.Location("Undersea Grotto", string.Empty, setName, 2, 3)
                .WithGeneric()
            ...
            Cards.Add(Card.Location("Cursed Caverns", string.Empty, setName, 3, 5)
                .WithGeneric()
                .WithTraits("Underground.", "Grotto.")
            ...
            Cards.Add(Card.Location("Watter-logged Halls", string.Empty, setName, 2, 4)
                .WithGeneric()
                .WithTraits("Ruins.", "Underground.", "Grotto.")
            ...
            Cards.Add(Card.Location("Dark Abyss", string.Empty, setName, 5, 12)
                .WithGeneric()
            ...
            Cards.Add(Card.Location("Twisting Hollow", string.Empty, setName, 4, 14)
                .WithGeneric()
                .WithTraits("Underground.", "Underwater.")
            ...
            Cards.Add(Card.Location("Sunken Temple", string.Empty, setName, 3, 10)
                .WithGeneric()
                .WithTraits("Ruins.", "Underground.", "Underwater.")
            ...
            Cards.Add(Card.Location("Drowned Cave", string.Empty, setName, 3, 4)
                .WithGeneric()
                .WithTraits("Underground.", "Underwater.")
            ...
            Cards.Add(Card.Treachery("Powerful Undertow", string.Empty, setName)
                .WithTraits("Hazard.")
            ...
            Cards.Add(Card.Treachery("Into the Abyss", string.Empty, setName)
            ...
            Cards.Add(Card.Treachery("Tangling and Grasping", string.Empty, setName)
                .WithTraits("Hazard.")
            ...
            Cards.Add(Card.Treachery("Ancient Depths", string.Empty, setName)
