...
Finally, flip this setup card over and place it next to the quest deck. Its effects remain active throughout the game, which is now ready to begin.")
            ...
            Cards.Add(Card.Enemy("Bellach's Bodyguard", "", setName, 45, 4, 4, 3, 6)
            ...
            Cards.Add(Card.Enemy("Little Snuffler", "", setName, 15, 3, 3, 2, 3)
            ...
            Cards.Add(Card.Location("Bones of Hollin", "", setName, 3, 4)
            ...
            Cards.Add(Card.Location("Dusty Labyrinth", "", setName, 2, 5)
                .WithTraits("Ost-in-Edhil.", "Ruins.")
            ...
            Cards.Add(Card.Treachery("Hateful Search", "", setName)
            ...
            Cards.Add(Card.Treachery("Sauron's Agent", "", setName)
            ...
            Cards.Add(Card.Treachery("Closing In", "", setName)
                .WithKeywords("Surge.")
