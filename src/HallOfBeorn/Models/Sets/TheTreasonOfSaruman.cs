...
namespace HallOfBeorn.Models.Sets
{
    public class TheTreasonOfSaruman : CardSet
    {
        protected override void Initialize()
        {
            ...
            Cards.Add(Card.Objective("The Defense of Helm's Deep", "84C8BB39-EABC-47FF-8F1E-E87C68B11395", "Helm's Deep")
                .WithTraits("Siege.")
            ...
            Cards.Add(Card.Enemy("Wild Hillman", "3D3119FE-674C-4F7C-AE5B-4DC646565787", "Helm's Deep", 24, 3, 3, 2, 3)
                .WithTraits("Dunland.")
            ...
            Cards.Add(Card.Enemy("Warrior of Dunland", "07052600-1902-45B6-A502-EF82C106C951", "Helm's Deep", 44, 4, 5, 1, 5)
                .WithTraits("Dunland.")
            ...
            Cards.Add(Card.Enemy("Soldier of Isengard", "F4D452F8-86C4-47F1-B362-5B32E73EC0A5", "Helm's Deep", 39, 4, 4, 1, 4)
                .WithTraits("Orc.", "Uruk-hai.")
            ...
            Cards.Add(Card.Location("The Hornburg", "9E26553F-F2EA-4A27-BDB5-1DA6C2ADB791", "Helm's Deep", 3, 3)
            ...
            Cards.Add(Card.Location("Deeping Wall", "D46BCD9B-D1FE-421E-BA27-9F48D2267754", "Helm's Deep", 4, 4)
                .WithTraits("Helm's Deep.")
            ...
            Cards.Add(Card.Location("Deeping Culvert", "26D3320F-F710-478A-BBE6-EE8CBC3E61E6", "Helm's Deep", 255, 2)
                .WithTraits("Helm's Deep.")
                ...
                .WithEasyModeQuantity(1));
            Cards.Add(Card.Location("Postern Door", "65FAEBB5-E1B0-46F5-ADDE-C90CF17565DD", "Helm's Deep", 3, 2)
                .WithTraits("Helm's Deep.")
            ...
            Cards.Add(Card.Location("Helm's Gate", "9035733E-1686-4A19-94B1-5241ED68FFA9", "Helm's Deep", 5, 3)
                .WithTraits("Helm's Deep.")
                ...
                .WithEasyModeQuantity(1));
            Cards.Add(Card.Treachery("Scaling Ladders", "4E69C4A6-39DE-4269-82D5-243FB257AB3D", "Helm's Deep")
                .WithKeywords("Surge.")
            ...
            Cards.Add(Card.Treachery("Reckless Hate", "DA50FA48-D71B-4557-A4CA-DD27305FCFF9", "Helm's Deep")
                .WithKeywords("Peril.")
            ...
            Cards.Add(Card.Treachery("Night Without End", "FC5B7B75-8850-4A63-9B5F-4918FAE039CC", "Helm's Deep")
            ...
            Cards.Add(Card.Enemy("Isengard Uruk", "163EC4D2-49F5-470D-AD11-22BEDE7028F4", "Orcs of the White Hand", 34, 2, 3, 1, 4)
                ...
                .WithEasyModeQuantity(2));
            Cards.Add(Card.Enemy("Uruk-hai Fighter", "932CB527-A2B5-4F10-B116-CCBEAAAB109E", "Orcs of the White Hand", 29, 3, 3, 2, 3)
                .WithTraits("Orc.", "Uruk-hai")
            ...
            Cards.Add(Card.Treachery("Fighting Uruk-hai", "B4944214-09A6-4C50-8E08-5730B1C2523F", "Orcs of the White Hand")
                .WithKeywords("Peril.")
                ...
                .WithEasyModeQuantity(1));
            Cards.Add(Card.Enemy("Snaga", "F6632E8B-1E39-45CD-A67D-361CCED2A8AD", "Snaga Orcs", 44, 1, 3, 1, 3)
                .WithTraits("Orc.")
                .WithKeywords("Peril.", "Archery 1")
                ...
                .WithEasyModeQuantity(2));
            Cards.Add(Card.Treachery("Saruman's Orders", "EA6C6B8F-2E95-4A48-8DF1-0ACB0D0DB1C1", "Snaga Orcs")
                ...
                .WithEasyModeQuantity(1));
            Cards.Add(Card.Treachery("Saruman's Voice", "021B05CB-0498-44B2-BF15-31F3FF150042", "The Road to Isengard")
                .WithBurden()
                .WithTraits("Enchantment.")
                .WithKeywords("Peril.", "Doomed 2.")
