...
namespace HallOfBeorn.Models.Sets
{
    public class AcrossTheEttenmoors : CardSet
    {
        ...
        protected override void Initialize()
        {
            ...
            Cards.Add(Card.Quest("A Miserable Journey", "", 3, 2, setName, 20)
            ...
            Cards.Add(Card.Quest("Journey's End", "", 3, 3, setName, 17)
            ...
            Cards.Add(Card.ObjectiveLocation("Secluded Cave", setName, 7)
            ...
            Cards.Add(Card.ObjectiveLocation("The Hoarwell", setName, 3)
            ...
            Cards.Add(Card.ObjectiveLocation("Abandoned Camp", setName, 1)
            ...
            Cards.Add(Card.ObjectiveLocation("Patch of Woods", setName, 5)
            ...
            Cards.Add(Card.Enemy("Savage Trollspawn", "", setName, 36, 1, 2, 3, 6)
                .WithTraits("Troll.")
            ...
            Cards.Add(Card.Enemy("Coldfell Giant", "", setName, 41, 3, 5, 4, 7)
                .WithTraits("Giant.")
            ...
            Cards.Add(Card.Enemy("Cruel Mountain-troll", "", setName, 46, 3, 6, 2, 9)
                .WithTraits("Troll.")
            ...
            Cards.Add(Card.Enemy("Ruthless Hill-troll", "", setName, 31, 2, 4, 1, 12)
                .WithTraits("Troll.")
            ...
            Cards.Add(Card.Enemy("Goblin Pursuer", "", setName, 16, 2, 2, 2, 3)
            ...
            Cards.Add(Card.Location("Troll-fells", "", setName, 1, 6)
                .WithTraits("Ettenmoors.")
            ...
            Cards.Add(Card.Location("Barren Moorland", "", setName, 2, 4)
                .WithTraits("Ettenmoors.")
            ...
            Cards.Add(Card.Treachery("Arador's Bane", "", setName)
            ...
            Cards.Add(Card.Treachery("No Rest", "", setName)
            ...
            Cards.Add(Card.EncounterSideQuest("Lie Low", "", setName, 8)
            ...
            Cards.Add(Card.EncounterSideQuest("Forage for Food", "", setName, 6)
            ...
            Cards.Add(Card.EncounterSideQuest("Scavenge for Supplies", "", setName, 7)
