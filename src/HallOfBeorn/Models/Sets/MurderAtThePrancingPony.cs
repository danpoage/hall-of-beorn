...
namespace HallOfBeorn.Models.Sets
{
    public class MurderAtThePrancingPony : CardSet
    {
        ...
        protected override void Initialize()
        {
            ...
            Cards.Add(Card.Hero("Legolas", "", Sphere.Tactics, 9, 1, 3, 1, 4)
            ...
            Cards.Add(Card.Location("Bill Ferny's House", "", investigationSetName, 5, 5)
                .WithUnique()
                .WithTraits("Hideout.")
            ...
            Cards.Add(Card.Location("Archet Trading Post", "", investigationSetName, 5, 5)
                .WithUnique()
                .WithTraits("Hideout.")
            ...
            Cards.Add(Card.Location("Chetwood Campsite", "", investigationSetName, 5, 5)
                .WithUnique()
                .WithTraits("Hideout.")
            ...
            Cards.Add(Card.Enemy("Todd the Troll", "", investigationSetName, 45, 2, 7, 2, 10)
                .WithUnique()
            ...
            Cards.Add(Card.Enemy("Wolf-pelt Jake", "", investigationSetName, 45, 4, 5, 3, 7)
                .WithUnique()
                .WithTraits("Suspect.", "Brigand.")
            ...
            Cards.Add(Card.Enemy("Johnny Goblin-fingers", "", investigationSetName, 45, 3, 4, 4, 6)
                .WithUnique()
                .WithTraits("Suspect.", "Brigand.")
            ...
            Cards.Add(Card.Enemy("Old Orc-eyes", "", investigationSetName, 45, 3, 4, 3, 9)
                .WithUnique()
                .WithTraits("Suspect.", "Brigand.")
            ...
            Cards.Add(Card.Location("Ramshackle Manor", "", setName, 2, 3)
                .WithTraits("Bree.")
            ...
            Cards.Add(Card.Location("Dark Alley", "", setName, 4, 3)
                .WithTraits("Bree.")
            ...
            Cards.Add(Card.Location("Market Square", "", setName, 2, 4)
                .WithTraits("Bree.")
                .WithKeywords("Investigate 2.")
            ...
            Cards.Add(Card.Location("Old Warehouse", "", setName, 3, 4)
                .WithTraits("Bree.")
            ...
            Cards.Add(Card.Enemy("Lawless Ruffian", "", setName, 35, 2, 3, 2, 3)
                .WithTraits("Brigand.")
            ...
            Cards.Add(Card.Treachery("Smoke and Mirrors", "", setName)
            ...
            Cards.Add(Card.Treachery("Rising Body Count", "", setName)
