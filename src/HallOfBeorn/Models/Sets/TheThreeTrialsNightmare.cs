...
Finally, flip this setup card over and place it next to the quest deck. Its effects remain active throughout the game, which is now ready to begin.",
            ...
            Cards.Add(Card.Enemy("Wolf Spirit", "", setName, 30, 2, 5, 1, 6)
            ...
            Cards.Add(Card.Enemy("Boar Spirit", "", setName, 20, 1, 4, 2, 5)
            ...
            Cards.Add(Card.Enemy("Raven Spirit", "", setName, 40, 3, 3, 3, 4)
            ...
            Cards.Add(Card.Location("Sacred Forest", "", setName, 3, 5)
                .WithTraits("Forest.")
            ...
            Cards.Add(Card.Location("Haunted Pillars", "", setName, 2, 3)
            ...
            Cards.Add(Card.Treachery("Cursed Burden", "", setName)
                .WithKeywords("Surge.")
            ...
            Cards.Add(Card.Treachery("Trial of Ancestors", "", setName)
