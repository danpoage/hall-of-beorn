...
namespace HallOfBeorn.Models
{
    public class Card
    {
        ...
        */
        ...
        {
            Notes.Add(new CardNote { Text = text });
            return this;
        }

        public Card WithNote(string text, DateTime? date)
        {
            Notes.Add(new CardNote { Text = text, Date = date });
            return this;
        }

        public Card WithNote(string text, decimal faqVersion)
        {
            Notes.Add(new CardNote { Text = text, FaqVersion = faqVersion });
            return this;
        }

        public Card WithNote(string text, DateTime date, decimal faqVersion)
        {
            Notes.Add(new CardNote { Text = text, Date = date, FaqVersion = faqVersion });
            return this;
        }

        public Card WithNote(string text, DateTime date, decimal faqVersion, string url)
        {
