...
namespace HallOfBeorn.Models.Arkham.Products
{
    public class CoreSet : ArkhamProduct
    {
        ...
        protected override void init()
        {
            ...
            addCard(ArkhamCard.Enemy("Mob Enforcer", Number.Of(4), Number.Of(3), Number.Of(3), Number.Of(1), Number.Of(0), ArkhamEncounterSet.None)
            ...
            addCard(ArkhamCard.Enemy("Silver Twilight Acolyte", Number.Of(2), Number.Of(3), Number.Of(3), Number.Of(1), Number.Of(0), ArkhamEncounterSet.None)
                .WithSubtype(ArkhamCardSubtype.Basic_Weakness)
            ...
            addCard(ArkhamCard.Enemy("Stubborn Detective", Number.Of(3), Number.Of(2), Number.Of(2), Number.Of(1), Number.Of(0), ArkhamEncounterSet.None)
                .WithSubtype(ArkhamCardSubtype.Basic_Weakness)
            ...
            addCard(ArkhamCard.ScenarioReference("The Gathering", "Scenario Reference", ArkhamEncounterSet.The_Gathering)
            ...
            addCard(ArkhamCard.Agenda("What's Going On?!", "A Lapse in Time", 1, Number.Of(3), ArkhamEncounterSet.The_Gathering)
            ...
            addCard(ArkhamCard.Agenda("Rise of the Ghouls", "The Tunnels Below", 2, Number.Of(7), ArkhamEncounterSet.The_Gathering)
            ...
            addCard(ArkhamCard.Agenda("They're Getting Out!", "The Ghouls Break Free", 3, Number.Of(10), ArkhamEncounterSet.The_Gathering)
            ...
            addCard(ArkhamCard.Act("Trapped", "The Door on the Floor", 1, Number.Of(2).PerInvestigator(), ArkhamEncounterSet.The_Gathering)
            ...
            addCard(ArkhamCard.Act("The Barrier", "Breaking the Barrier", 2, Number.Of(3).PerInvestigator(), ArkhamEncounterSet.The_Gathering)
            ...
            addCard(ArkhamCard.Act("What Have You Done?", "Defending the Home", 3, Number.NA, ArkhamEncounterSet.The_Gathering)
            ...
            addCard(ArkhamCard.Location("Study", ConnectionSymbol.Study, Shroud.Of(2), ClueValue.Of(2).PerInvestigator(), ArkhamEncounterSet.The_Gathering)
            ...
            addCard(ArkhamCard.Location("Hallway", ConnectionSymbol.Hallway, Shroud.Of(1), ClueValue.Of(0), ArkhamEncounterSet.The_Gathering)
            ...
            addCard(ArkhamCard.Location("Attic", ConnectionSymbol.Attic, Shroud.Of(1), ClueValue.Of(2).PerInvestigator(), ArkhamEncounterSet.The_Gathering)
                .WithVictoryPoints(1)
            ...
            addCard(ArkhamCard.Location("Cellar", ConnectionSymbol.Cellar, Shroud.Of(4), ClueValue.Of(2).PerInvestigator(), ArkhamEncounterSet.The_Gathering)
                .WithVictoryPoints(1)
            ...
            addCard(ArkhamCard.Location("Parlor", ConnectionSymbol.Parlor, Shroud.Of(2), ClueValue.Of(0), ArkhamEncounterSet.The_Gathering)
            ...
            addCard(ArkhamCard.Enemy("Ghoul Priest", Number.Of(4), Number.Of(5).PerInvestigator(), Number.Of(4), Number.Of(2), Number.Of(2), ArkhamEncounterSet.The_Gathering)
            ...
            addCard(ArkhamCard.Asset("Lita Chantler", ClassSymbol.None, 0, AssetSlot.Ally)
                ...
                .WithEncounterSet(ArkhamEncounterSet.The_Gathering)
                .WithUnique()
                .WithTraits("Ally.")
            ...
            addCard(ArkhamCard.Enemy("Flesh-Eater", Number.Of(4), Number.Of(4), Number.Of(1), Number.Of(1), Number.Of(2), ArkhamEncounterSet.The_Gathering)
            ...
            addCard(ArkhamCard.Enemy("Icy Ghoul", Number.Of(3), Number.Of(4), Number.Of(4), Number.Of(2), Number.Of(1), ArkhamEncounterSet.The_Gathering)
                .WithTraits("Humanoid.", "Monster.", "Ghoul.")
