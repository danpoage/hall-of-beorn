...
namespace HallOfBeorn.Models.Arkham.Products
{
    public class CoreSet : ArkhamProduct
    {
        ...
        protected override void init()
        {
            ...
            addCard(ArkhamCard.Enemy("Mob Enforcer", Number.Of(4), Number.Of(3), Number.Of(3), Number.Of(1), Number.Of(0), ArkhamEncounterSet.The_Gathering)
            ...
            addCard(ArkhamCard.Enemy("Silver Twilight Acolyte", Number.Of(2), Number.Of(3), Number.Of(3), Number.Of(1), Number.Of(0), ArkhamEncounterSet.The_Gathering)
                .WithSubtype(ArkhamCardSubtype.Basic_Weakness)
            ...
            addCard(ArkhamCard.Enemy("Stubborn Detective", Number.Of(3), Number.Of(2), Number.Of(2), Number.Of(1), Number.Of(0), ArkhamEncounterSet.The_Gathering)
                .WithSubtype(ArkhamCardSubtype.Basic_Weakness)
            ...
            addCard(ArkhamCard.ScenarioReference("The Gathering", "Scenario Reference")
